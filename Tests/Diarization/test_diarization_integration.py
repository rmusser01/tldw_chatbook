...
class TestDiarizationIntegration(unittest.TestCase):
    ...
    def test_format_segments_with_speakers(self):
        ...
        formatted = self.service.format_segments_with_timestamps(
            segments, include_timestamps=True, include_speakers=True
        )
    ...
    def test_progress_callback(self):
        ...
        try:
            ...
            diarization_updates = [
                ...
                if "diarization" in u["status"].lower()
                or (u["data"] and "diarization_stage" in u.get("data", {}))
            ]
