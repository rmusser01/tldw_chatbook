...
def session_data():
    ...
    return ChatSessionData(
        tab_id="test-123", title="Test Chat", character_name="TestBot"
    )
...
class TestChatTabBar:
    ...
    async def test_add_tab_with_character(self, tab_bar):
        ...
        session_data = ChatSessionData(
            tab_id="char-123", title="Character Chat", character_name="Alice"
        )
    ...
    def test_remove_tab_switches_to_next(self, tab_bar):
        ...
        tab_bar.tab_buttons = {"tab1": Mock(), "tab2": Mock(), "tab3": Mock()}
    ...
    def test_set_active_tab(self, tab_bar):
        ...
        button1 = Mock()
        button2 = Mock()
        tab_bar.tab_buttons = {"tab1": button1, "tab2": button2}
        tab_bar.post_message = Mock()
    ...
    def test_get_tab_count(self, tab_bar):
        ...
        tab_bar.tab_buttons = {"tab1": Mock(), "tab2": Mock()}
