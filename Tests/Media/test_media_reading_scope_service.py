...
def test_scope_service_reports_known_media_reading_capability_gaps():
    ...
    assert local_report == [
        ...
        },
        {
            ...
            "supported": False,
            "reason_code": "local_contract_missing",
            "user_message": "Local directory source sync, URL article ingest, and local file ingest jobs execute locally, but URL file/download ingest and non-directory source execution are not implemented yet.",
            "affected_action_ids": [
