...
#: PR #2125 and subsequent Console work through PR #2143 before this ratchet
#: landed. The final live measurement is: 17,727/593 -> 17,025/565.
_BUDGETS: dict[str, tuple[str, int, int]] = {
    "tldw_chatbook/UI/Screens/chat_screen.py": ("ChatScreen", 17025, 565),
}
