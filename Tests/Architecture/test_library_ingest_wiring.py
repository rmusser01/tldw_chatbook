...
#: callers to their existing controller owners; step 137 adds the pause wrapper:
#: current 45 KEEP, 11 PRUNED.
...
def test_screen_delegates_ingest_handlers() -> None:
    ...
    six unused delegates; TASK-31932 steps 76/137 retargeted five sole callers)
