...
#: `backlinks` (the Info panel's "Linked from (N)" rows) and
#: `backlinks_status` (whether that lookup has answered yet), taking the
#: censused 100 to 102; task-32100 added `navigation_focus_intent`, which
#: records whether the locator behind `navigation_status` will take focus
#: when it lands, taking it to 103.
