...
FRAMEWORK_ARMED_CLOCK_ROWS: dict[tuple[str, str, str], str] = {
    # Emptied at TASK-23028 rebase: TASK-23022 (PR #2156) converted every raw
    # ProgressBar/LoadingIndicator construction to the pausable house classes,
    # so no raw framework-armed construction remains to row. New raw
    # constructions fail the census and must either convert or add a row here.
}
