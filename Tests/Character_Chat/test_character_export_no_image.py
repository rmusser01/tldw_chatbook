...
def test_export_character_without_image_png_creates_default(
    db_instance, character_without_image, tmp_path
):
...
def test_export_character_with_image_both_formats(
    db_instance, character_with_image, tmp_path
):
...
def test_event_handler_logic_simulation():
    ...
    char_with_image = {"id": 1, "name": "ImageChar", "image": b"fake_image_bytes"}
