...
def test_hard_config_errors_filters_out_unexposed_field_violations(wired):
    ...
    # the mutation is visible without re-saving. This models a profile that
    # already carries this violation on disk (e.g. hand-edited, or migrated
    # from an older version) rather than one being saved right now.
