    ...
    class EmbeddingsWrapper:
        ...
        def _mock_encode(self, texts: List[str]) -> np.ndarray:
            ...
            for text in texts:
                ...
                embedding = np.random.RandomState(hash(text) % 2**32).rand(
                    self._dimension
                )
...
class TestEmbeddingsUtilities:
    ...
    def test_detect_embedding_provider_sentence_transformers(self):
        ...
        assert (
            detect_embedding_provider("sentence-transformers/all-mpnet-base-v2")
...
class TestEmbeddingsCaching:
    ...
    def test_cache_size_limit(self):
        ...
        wrapper = EmbeddingsWrapper(provider="mock", cache_enabled=True, cache_size=3)
