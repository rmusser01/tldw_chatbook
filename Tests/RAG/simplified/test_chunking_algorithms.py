...
class TestChunkingAlgorithms:
    ...
    def test_chunk_overlap(self, chunking_service):
        ...
        chunks = chunking_service.chunk_text(
            text, chunk_size=chunk_size * 5, chunk_overlap=overlap * 5
            ...
            for i in range(len(chunks) - 1):
                ...
                if len(current_words) > 0 and len(next_words) > 0:
                    ...
                    if not overlap_words and i == 0:
                        ...
                        warnings.warn(
                            f"No word overlap found between chunks {i} and {i + 1}"
                        )
    ...
    def test_short_document_handling(self, chunking_service):
        ...
        chunks = chunking_service.chunk_text(
            short_text, chunk_size=1000, chunk_overlap=100
        )
    ...
    def test_unicode_handling(self, chunking_service):
        ...
        chunks = chunking_service.chunk_text(
            unicode_text, chunk_size=20, chunk_overlap=5
        )
...
Third paragraph here."""
        ...
        chunks = chunking_service.chunk_text(
            text_with_newlines, chunk_size=50, chunk_overlap=10
        )
    ...
    def test_chunk_size_variations(self, chunking_service):
        ...
        # Small chunks
        small_chunks = chunking_service.chunk_text(
            text, chunk_size=50, chunk_overlap=10
        )

        # Large chunks
        large_chunks = chunking_service.chunk_text(
    ...
    def test_special_characters_in_text(self, chunking_service):
        ...
        chunks = chunking_service.chunk_text(
            text_with_special, chunk_size=30, chunk_overlap=5
        )
    ...
    def test_performance_characteristics(self, chunking_service):
        ...
        chunks = chunking_service.chunk_text(
            large_text, chunk_size=200, chunk_overlap=50
        )
...
class TestChunkingEdgeCases:
    ...
    def test_text_with_only_whitespace(self, chunking_service):
        ...
        whitespace_text = "    \n\n\t\t    \n    "
        chunks = chunking_service.chunk_text(
            whitespace_text, chunk_size=10, chunk_overlap=2
        )
