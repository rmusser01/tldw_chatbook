...
class TestSearchResultWithCitations:
    ...
    def test_search_result_creation(self):
        ...
        citations = [
            Citation(
                "doc1", "Doc 1", "chunk1", "Citation 1", 0, 10, 0.9, CitationType.EXACT
            ),
            Citation(
                "doc2",
                "Doc 2",
    ...
    def test_search_result_unique_sources(self):
        ...
        citations = [
            Citation(
                "doc1", "Doc 1", "chunk1", "Text 1", 0, 10, 0.9, CitationType.EXACT
            ),
            Citation(
                "doc1", "Doc 1", "chunk2", "Text 2", 20, 30, 0.8, CitationType.SEMANTIC
            ),
            Citation(
                "doc2", "Doc 2", "chunk1", "Text 3", 0, 10, 0.7, CitationType.KEYWORD
            ),
        ]

        result = SearchResultWithCitations(
            id="result1", score=0.9, document="Test", citations=citations
        )
    ...
    def test_search_result_serialization(self):
        ...
        result = SearchResultWithCitations(
            id="result1", score=0.9, document="Result content", citations=citations
        )
...
class TestCitationUtilities:
    ...
    def test_merge_citations_basic(self):
        ...
        citations_list = [
            ...
            [
                Citation(
                    "doc1", "Doc 1", "c1", "Text", 0, 10, 0.9, CitationType.EXACT
                ),  # Higher confidence
    ...
    def test_filter_overlapping_citations(self):
        ...
        citations = [
            Citation(
                "doc1", "Doc 1", "c1", "Full citation", 0, 100, 0.9, CitationType.EXACT
            ),
            Citation(
                "doc1",
                "Doc 1",
            ...
            Citation(
                "doc1", "Doc 1", "c3", "Contained", 10, 20, 0.8, CitationType.EXACT
            ),
            Citation(
                "doc1", "Doc 1", "c4", "No overlap", 200, 250, 0.75, CitationType.EXACT
            ),
            Citation(
                "doc2", "Doc 2", "c5", "Different doc", 0, 100, 0.7, CitationType.EXACT
            ),
        ]
...
class TestCitationProperties:
    ...
    def test_group_citations_completeness(self, citations):
        ...
        assert (
            set(c.document_id for c in citations) == set(groups.keys())
            or len(citations) == 0
        )
...
class TestCitationEdgeCases:
    ...
    def test_very_long_citation(self):
        ...
        citation = Citation(
            "doc1", "Doc", "c1", long_content, 0, 10000, 0.9, CitationType.EXACT
        )
    ...
    def test_overlapping_citations_prefer_exact(self):
        ...
        citations = [
            ...
            Citation(
                "doc1", "Doc", "c2", "Semantic", 15, 25, 0.9, CitationType.SEMANTIC
            ),
        ]
