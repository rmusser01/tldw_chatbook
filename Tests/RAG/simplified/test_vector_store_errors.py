...
class TestChromaVectorStoreErrors:
    ...
    def test_corrupted_metadata(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = store.search(query_embedding=[0.1] * 128, top_k=1)
...
class TestInMemoryVectorStoreErrors:
    ...
    def test_search_with_empty_store(self):
        ...
        results = store.search(query_embedding=[0.1] * 128, top_k=10)
    ...
    def test_invalid_distance_metric(self):
        ...
        with pytest.raises(ValueError, match="Unknown distance metric"):
            store.search(query_embedding=[0.1] * 128, top_k=2)
...
class TestRecoveryScenarios:
    ...
    def test_search_after_corruption(self):
        ...
        results = store.search(query_embedding=[0.2] * 128, top_k=10)
    ...
    async def test_concurrent_error_recovery(self):
        ...
        await asyncio.gather(failing_adder(), failing_adder(), return_exceptions=True)
