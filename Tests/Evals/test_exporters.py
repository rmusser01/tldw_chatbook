...
from tldw_chatbook.Evals.exporters import (
    EvaluationExporter,
    export_to_csv,
    export_to_json,
)
...
class MockABTestResult:
    ...
    def __init__(self):
        ...
        self.model_a_metrics = {"accuracy": 0.85, "f1": 0.82, "latency": 150.5}
        self.model_b_metrics = {"accuracy": 0.78, "f1": 0.75, "latency": 200.3}
        self.statistical_tests = {
            "accuracy": {"difference": 0.07, "p_value": 0.03, "is_significant": True},
            "f1": {"difference": 0.07, "p_value": 0.04, "is_significant": True},
        }
...
class TestEvaluationExporter:
    ...
    def test_export_ab_test_json(self, exporter, ab_test_result, tmp_path):
        ...
        exporter._export_ab_test_json(
            ab_test_result, output_path, {"include_raw_outputs": False}
        )
...
class TestLegacyFunctions:
    ...
    def test_export_to_csv_legacy(self, tmp_path):
        ...
        run_data = {"run_id": "legacy_csv", "results": [{"id": "1", "value": "test"}]}
    ...
    def test_export_to_json_legacy(self, tmp_path):
        ...
        run_data = {"run_id": "legacy_json", "metrics": {"test": 1.0}}
...
class TestExportOptions:
    ...
    def test_json_export_without_raw_outputs(self, exporter, tmp_path):
        ...
        exporter._export_run_json(data, output_path, {"include_raw_outputs": False})
    ...
    def test_json_export_without_metadata(self, exporter, tmp_path):
        ...
        data = {"run_id": "test", "metadata": {"should": "be_excluded"}, "results": []}

        output_path = tmp_path / "no_metadata.json"

        exporter._export_run_json(data, output_path, {"include_metadata": False})
