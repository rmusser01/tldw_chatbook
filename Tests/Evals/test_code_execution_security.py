...
class TestCodeExecutionSecurity:
    ...
    def code_runner(self):
        ...
        model_config = {"provider": "mock", "model_id": "test-model"}
    ...
    def test_resource_limits_in_generated_code(self, code_runner):
        ...
        assert (
            "resource.setrlimit(resource.RLIMIT_NOFILE" in test_code
        )  # File descriptors
    ...
    def test_malicious_code_blocked(self, code_runner):
        ...
        sample = TestEvalSample(
            id="test2", input_text="Test malicious code", expected_output="blocked"
        )
...
"""
        ...
        if results["test_results"]:
            ...
            assert any(
                result.get("result") == "blocked" for result in results["test_results"]
            )
...
"""
    ...
    def test_memory_exhaustion_prevented(self, code_runner):
        ...
        sample = TestEvalSample(
            id="test4", input_text="Test memory limits", expected_output="blocked"
        )
...
"""
    ...
    def test_file_operations_blocked(self, code_runner):
        ...
        sample = TestEvalSample(
            id="test5", input_text="Test file operations", expected_output="blocked"
        )
