...
class StreamingTestApp(App):
    ...
    def __init__(self):
        ...
        self.app_config = {
            ...
            "chat": {"images": {"enabled": True, "default_render_mode": "auto"}},
        }
    ...
    def get_current_ai_message_widget(self):
        ...
        if not self.current_ai_widget:
            ...
            self.current_ai_widget = ChatMessageEnhanced(
                message="", role="AI", message_id="test_msg_123"
            )
...
class TestChatStreamingWithTextual:
        ...
        with patch(
            ...
            async with app.run_test() as pilot:
                ...
                ai_widget = ChatMessageEnhanced(
                    message="Initial.", role="AI", message_id="test_msg_123"
                )
    ...
    async def test_handle_stream_done_marks_complete(self, streaming_app):
        ...
        with patch(
            "tldw_chatbook.Event_Handlers.Chat_Events.chat_streaming_events.ccl"
        ) as mock_ccl:
    ...
    @pytest.mark.asyncio
    async def test_handle_stream_done_attaches_answer_citation_validation(
        self, streaming_app
    ):
