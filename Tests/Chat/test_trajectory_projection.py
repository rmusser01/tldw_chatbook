...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('  file "package/module.py", line 42, in run', True),
        ("    at run (package/module.js:42:5)", True),
        ("GET /api/v1/models HTTP/1.1 cwd=/private/work", True),
        ("POST /docs/getting-started HTTP/1.1 cd /srv/build", True),
        ("cd /docs/getting-started", True),
        ("cwd=/arbitrary/root", True),
        ("output lives at /arbitrary/root/file", True),
        ("ls /docs/private/local", True),
        ("cat /docs/private/local", True),
        ("open /help/private/local", True),
        ("less /api/private/local", True),
        ("head /docs/private/local", True),
        ("tail /help/private/local", True),
        ("path=/api/v1/models", True),
        ('{"file_path": "/api/v1/models"}', True),
        ('{"meta": {"cwd": "/docs/getting-started"}}', True),
        ("{'directory': '/help/topic'}", True),
        ('{"endpoint": "/api/v1/models"}', False),
        ...
        ("rendered HTML: <div>safe</div>", False),
        ("3/4 + 5/6", False),
