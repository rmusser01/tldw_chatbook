...
from tldw_chatbook.tldw_api.utils import prepare_files_for_httpx, cleanup_file_objects
...
class TestCharacterChatFileOperations:
    ...
    def test_load_chat_history_with_valid_path(
        self, mock_db, temp_base_dir, sample_chat_history
    ):
        ...
        conv_id, char_id = load_chat_history_from_file_and_save_to_db(
            mock_db, str(chat_file), base_directory=temp_base_dir
        )
    ...
    def test_load_chat_history_with_invalid_path(self, mock_db, temp_base_dir):
        ...
        try:
            ...
            conv_id, char_id = load_chat_history_from_file_and_save_to_db(
                mock_db, outside_file, base_directory=temp_base_dir
            )
    ...
    def test_load_chat_history_with_path_traversal(self, mock_db, temp_base_dir):
        ...
        conv_id, char_id = load_chat_history_from_file_and_save_to_db(
            mock_db, malicious_path, base_directory=temp_base_dir
        )
    ...
    def test_load_chat_history_from_file_object(self, mock_db, sample_chat_history):
        ...
        conv_id, char_id = load_chat_history_from_file_and_save_to_db(mock_db, file_obj)
...
class TestAPIUtilsFileOperations:
    ...
    def test_prepare_files_with_valid_paths(self, temp_upload_dir):
        ...
        httpx_files = prepare_files_for_httpx(validated_paths)
    ...
    def test_prepare_files_with_path_traversal(self, temp_upload_dir):
        ...
        file_paths = [str(Path(temp_upload_dir) / ".." / ".." / "etc" / "passwd")]
    ...
    def test_prepare_files_without_validation(self, temp_upload_dir):
        ...
        file_paths = [str(Path(temp_upload_dir) / "test_file_0.txt")]
