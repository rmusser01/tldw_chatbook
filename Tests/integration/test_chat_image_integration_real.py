...
pytestmark = [
    ...
    pytest.mark.skip(reason="ChatWindowEnhanced not currently in use"),
]
...
class TestChatImageIntegration:
    ...
    async def test_attach_image_button_flow(self, real_app_with_image_support):
        ...
        async with app.run_test() as pilot:
            ...
            try:
                ...
                pytest.skip(
                    "Image attachment requires ChatWindowEnhanced (enable with image_support setting)"
                )
    ...
    @pytest.mark.asyncio
    async def test_image_path_submission_success(
        self, real_app_with_image_support, temp_test_image
    ):
    ...
    @pytest.mark.asyncio
    async def test_image_path_submission_invalid_file(
        self, real_app_with_image_support
    ):
    ...
    @pytest.mark.asyncio
    async def test_clear_image_attachment(
        self, real_app_with_image_support, temp_test_image
    ):
    ...
    @pytest.mark.asyncio
    async def test_image_preview_display(
        self, real_app_with_image_support, temp_test_image
    ):
    ...
    @pytest.mark.asyncio
    async def test_multiple_image_attachments_not_allowed(
        self, real_app_with_image_support, temp_test_image
    ):
        ...
        async with app.run_test() as pilot:
            ...
            if "hidden" not in file_input.classes:
                ...
                assert (
                    chat_window.pending_image["data"] == first_image_data
                )  # Same file
            else:
