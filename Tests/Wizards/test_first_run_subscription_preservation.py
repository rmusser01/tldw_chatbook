...
@pytest.mark.parametrize("source", [None, "none", "stored", "environment"])
def test_unchanged_subscription_preserves_credentials_after_atomic_save_and_reload(
...
def test_explicit_subscription_clear_or_replacement_remains_authoritative(
...
def test_preserving_subscription_setup_keeps_atomic_conflict_checks(
