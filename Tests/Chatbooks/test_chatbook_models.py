...
class TestContentItem:
    ...
    def test_content_item_creation(self):
        ...
        item = ContentItem(
            id="test_123", type=ContentType.CONVERSATION, title="Test Conversation"
        )
...
class TestRelationship:
    ...
    def test_relationship_creation(self):
        ...
        rel = Relationship(
            source_id="conv_1", target_id="char_1", relationship_type="uses_character"
        )
...
class TestChatbookManifest:
    ...
    def test_manifest_to_dict(self):
        ...
        manifest = ChatbookManifest(
            ...
            author="Test Author",
            content_items=[ContentItem(id="1", type=ContentType.NOTE, title="Note 1")],
            tags=["test"],
        )
...
class TestChatbook:
    ...
    def test_chatbook_creation(self):
        ...
        manifest = ChatbookManifest(
            version=ChatbookVersion.V1, name="Test Chatbook", description="Test"
        )
