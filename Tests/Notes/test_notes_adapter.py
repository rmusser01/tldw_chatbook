...
class TestNotesInteropService:
    ...
    def __init__(
        self, db: CharactersRAGDB, notes_directory: str, sync_enabled: bool = False
    ):
        """
    ...
    def update_note(
        ...
        success = self.db.update_note(
            note_id=note_id, update_data=update_data, expected_version=note["version"]
        )
    ...
    def delete_note(self, note_id: str) -> bool:
        ...
        success = self.db.soft_delete_note(
            note_id=note_id, expected_version=note["version"]
        )
...
def NotesInteropService(
    db: CharactersRAGDB, notes_directory: str, sync_enabled: bool = False
) -> TestNotesInteropService:
    """Factory function that creates a TestNotesInteropService instance."""
    return TestNotesInteropService(
        db=db, notes_directory=notes_directory, sync_enabled=sync_enabled
    )
