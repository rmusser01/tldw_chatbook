...
from tldw_chatbook.Chunking._shims.Chat import bounded_daemon
from tldw_chatbook.Chunking.engine import auto_boundary_assistant as assistant_module
from tldw_chatbook.Chunking.engine.auto_boundary_assistant import (
...
async def test_chat_assistant_does_not_offload_native_async_chat_call(
    ...
    monkeypatch.setattr(
        "tldw_chatbook.Chunking.engine.auto_boundary_assistant.asyncio.to_thread",
        tracking_to_thread,
    )
    assistant = ChatAutoChunkBoundaryAssistant(
        chat_call=chat_call,
