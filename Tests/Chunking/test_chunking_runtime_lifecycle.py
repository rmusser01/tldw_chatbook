...
from tldw_chatbook.Chunking._shims.AuthNZ.byok_runtime import ServerFallbackCredentials
from tldw_chatbook.Chunking._shims.AuthNZ.user_provider_secrets import (
...
from tldw_chatbook.Chunking.engine.templates import TemplateProcessor
...
async def test_chunking_real_byok_resolution_cannot_mix_config_generations(
    ...
    from tldw_chatbook.Chunking._shims.AuthNZ import byok_runtime
    from tldw_chatbook.Chunking._shims.AuthNZ.settings import reset_settings
