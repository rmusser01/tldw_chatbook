...
class TestConfigEncryption:
    ...
    def test_config(self):
        ...
        return {
            ...
            "timeout": 30,
            "enabled": True,
            "nested": {"secret": "nested_secret_value", "public": "public_value"},
        }
    ...
    def test_decrypt_wrong_version(self, encryptor, test_password):
        ...
        invalid_encrypted = encryptor.ENCRYPTION_PREFIX + base64.b64encode(
            wrong_version_data
        ).decode("utf-8")
    ...
    def test_verify_password_with_invalid_verifier(self, encryptor, test_password):
        ...
        assert (
            encryptor.verify_password(
                test_password, encryptor.ENCRYPTION_PREFIX + "invalid"
            )
            is False
        )
    ...
    def test_encrypt_config_simple(self, encryptor, test_password):
        ...
        config = {"api_key": "secret_key", "timeout": 30, "enabled": True}
    ...
    def test_decrypt_config_partial_failure(self, encryptor, test_password):
        ...
        with patch("loguru.logger.warning") as mock_warning:
            ...
            assert (
                ...
                == encryptor.ENCRYPTION_PREFIX + "corrupted_data"
            )
    ...
    def test_encrypted_format_structure(self, encryptor, test_password):
        ...
        assert (
            len(combined)
            >= 1 + encryptor.SALT_SIZE + encryptor.NONCE_SIZE + encryptor.TAG_SIZE
        )
    ...
    def test_full_config_roundtrip(self, encryptor, test_password):
        ...
        config = {
            "api_settings": {
                ...
                "anthropic": {"api_key": "sk-anthropic-key", "model": "claude-3"},
            },
