...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The top Workbench action opens one responsive, mode-driven Console modal that supports Browse, Edit, Improve, and Recipe navigation with focus restoration and dirty-work protections.
