...
Reason: Implements ADR-022's accepted single config persistence owner and live request-boundary snapshot while preserving ADR-004 and ADR-006.
...
ADR: backlog/decisions/022-local-private-data-boundary.md. Detailed plan: Docs/superpowers/plans/2026-07-24-exclusive-config-persistence-runtime.md.
<!-- SECTION:NOTES:END -->
