...
- Added measured responsive behavior for the real Models/Lab body at 80 columns, normalized untrusted update timestamps, preserved keyboard focus across in-place pane updates, and restored validated selected-model context with progress after screen recomposition.
