---
id: TASK-26992
title: Clean Ruff formatter debt for ruff-tests-misc
status: To Do
assignee: []
...
<!-- TASK-26000-BATCH: ruff-tests-misc -->
<!-- TASK-26000-PATHS-SHA256: 91c6bc728563304ac5bbd5cb82439aa21c388b8695af80637b4bb459a654b159 -->
<!-- TASK-26000-FINAL: false -->

## Description

<!-- SECTION:DESCRIPTION:BEGIN -->
Clean the `ruff-tests-misc` Ruff formatter batch at the owner boundary recorded as: Remaining test-only helpers grouped by the shared pytest surface.. The focused test surface recorded by TASK-26000 is `["Tests"]`.
...
```json
[
  "Tests/fixtures/required_doubles.py"
]
```
