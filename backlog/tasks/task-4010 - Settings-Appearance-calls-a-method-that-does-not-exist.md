...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Settings ▸ Appearance composes and its three boolean toggles render/flip without AttributeError, verified live
- [ ] #2 The four ambient failures in Tests/UI/test_settings_footer_hints.py pass on dev
- [ ] #3 A regression test (or the repaired ones) pins the label contract the nine call sites share
<!-- AC:END -->
