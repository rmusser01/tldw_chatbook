...
- **Gate reconciliation (post-PR):** the deletion removed 53 diagnostic statements; all verified to fall inside the deleted dead-function ranges before the sanctioned inventory re-pin and manifest-boundary re-pin (`623936cb44`).
