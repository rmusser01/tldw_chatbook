...
- [x] #3 Saved, pending, ready, failed and unavailable states are distinguished per load; source, View previous and confirmed unsent repair remain usable in both modes.
<!-- AC:END -->
