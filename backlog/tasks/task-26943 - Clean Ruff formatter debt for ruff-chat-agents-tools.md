---
id: TASK-26943
title: Clean Ruff formatter debt for ruff-chat-agents-tools
status: To Do
assignee: []
...
<!-- TASK-26000-BATCH: ruff-chat-agents-tools -->
<!-- TASK-26000-PATHS-SHA256: dde0ba71fdcb015f49f5473ef5990aa8a132cc4b5403d44f80defe03b9759438 -->
<!-- TASK-26000-FINAL: false -->

## Description

<!-- SECTION:DESCRIPTION:BEGIN -->
Clean the `ruff-chat-agents-tools` Ruff formatter batch at the owner boundary recorded as: Chat agent/tool approval and execution seams with their direct Chat tests.. The focused test surface recorded by TASK-26000 is `["Tests/Chat"]`.
...
[
  ...
  "Tests/Chat/test_tool_output_disclosure.py"
]
```
