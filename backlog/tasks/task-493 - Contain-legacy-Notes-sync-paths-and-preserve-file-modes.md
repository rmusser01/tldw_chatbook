...
Reason: ADR-022 already establishes the legacy Notes containment and mode-preservation policy; TASK-493 implements it without changing ADR-021 authority/recovery scope.
...
ADR: existing backlog/decisions/022-local-private-data-boundary.md; no new ADR required. Detailed plan: Docs/superpowers/plans/2026-07-24-legacy-notes-sync-containment.md.
<!-- SECTION:NOTES:END -->
