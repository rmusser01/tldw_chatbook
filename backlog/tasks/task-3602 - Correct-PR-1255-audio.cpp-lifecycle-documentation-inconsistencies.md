...
- [ ] #2 The adapter-registry design distinguishes the original 2026-07-23 approval from the user-approved 2026-08-02 managed-lifecycle amendment without conflating written-specification approval with per-install runtime artifact selection and trust.
