...
Spec: Docs/superpowers/specs/2026-08-04-local-agent-tools-design.md (phase 2). Plan: Docs/superpowers/plans/2026-08-04-local-agent-tools-phase2.md. ADR: backlog/decisions/032. Builds on task-2819 (phase 1, fs_list pilot). NOTE: fs_list already landed in phase 1 and is out of scope here.
