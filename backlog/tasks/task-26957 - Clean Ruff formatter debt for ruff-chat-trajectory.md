---
id: TASK-26957
title: Clean Ruff formatter debt for ruff-chat-trajectory
status: To Do
assignee: []
...
<!-- TASK-26000-BATCH: ruff-chat-trajectory -->
<!-- TASK-26000-PATHS-SHA256: 14d8e4da92fa6172c32d044154a22ca5c6cc2102a7da48cf7431135154068ea9 -->
<!-- TASK-26000-FINAL: false -->

## Description

<!-- SECTION:DESCRIPTION:BEGIN -->
Clean the `ruff-chat-trajectory` Ruff formatter batch at the owner boundary recorded as: Chat trajectory capture/import/export and trace projection services.. The focused test surface recorded by TASK-26000 is `["Tests/Chat"]`.
...
```json
[
  "Tests/Chat/test_trace_event_projection.py",
  "Tests/Chat/test_trajectory_capture.py",
  "Tests/Chat/test_trajectory_import.py",
  "Tests/Chat/test_trajectory_projection.py",
