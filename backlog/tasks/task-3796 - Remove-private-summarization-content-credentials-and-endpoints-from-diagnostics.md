---
id: TASK-3796
title: Remove private summarization content, credentials, and endpoints from diagnostics
status: To Do
assignee: []
...
Category totals: 13 raw/processed/extracted input, 8 prompt content, 8 credential fragments, 6 private endpoint/path values, and 29 response/output-content sites.

### `Summarization_General_Lib.py` — 77 sites
...
Category totals: 8 raw/processed/extracted input, 9 prompt content, 13 credential fragments, 5 private endpoint/path values, and 42 response/output-content sites.

## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Every verified raw/processed/extracted input, prompt, response/output, credential-fragment, and private endpoint/path diagnostic in the inventory emits metadata only
