...
TASK-130 remains In Progress for the broader provider/model UAT workstream because full end-to-end provider switching, endpoint/credential preservation, and non-streaming provider fallback still need their own runtime evidence before the whole task can be marked Done.
<!-- SECTION:NOTES:END -->
