...
references:
  ...
  - backlog/tasks/task-21351.1 - Implement-local-Active-History-CtrlK-activity-switcher.md
priority: medium
---
...
- [ ] #11 Blank-query Enter targets the MRU other open tab, explicit navigation and nonblank search target the highlighted committed result, and contextual onboarding plus deterministic domain-semantic state/workspace search work without transcript inspection, embeddings, or network calls.
<!-- AC:END -->
