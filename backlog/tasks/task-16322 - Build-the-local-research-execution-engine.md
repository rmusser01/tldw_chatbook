...
<!-- SECTION:PLAN:BEGIN -->
1. Write ADR-066 (local research execution engine contract + relationship to server run contract) BEFORE implementation
...
- Files: new `local_research_engine.py`, `UI/Screens/research_screen.py`, `ADR-066`, `Tests/Research/test_local_research_engine.py`; modified `local_research_service.py`, `screen_registry.py`, `route_inventory.py`, `Research_Window.py`, `test_local_research_service.py`, `test_research_screen.py`, `test_screen_navigation.py`.
<!-- SECTION:NOTES:END -->
