...
2026-09-08 rebase: dev 0fa35d00e8 already contains the constructor-local NotesSync and NoteImport imports. Retain that upstream implementation and the independent packaging regression, rather than replaying an eager NoteImport and duplicate local NotesSync import. Counts above are historical, not current combined-budget claims; the recipe's historical incident is now section 24.
