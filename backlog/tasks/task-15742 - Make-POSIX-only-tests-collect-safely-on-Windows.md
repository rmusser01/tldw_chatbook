...
Verification: repository-wide collect-only exited 0 with 42,293 tests collected in 100.99s and seven explicit module skips, including the TTS fcntl reason; neither prior collection error remains. The combined media+TTS matrix exited 0 with 33 passed and 4 skipped in 2.58s. Running the TTS module alone intentionally returns pytest exit 5 because its explicit module skip leaves no selected tests. Scoped Ruff, py_compile, and git diff --check passed. The repository-wide suite was stopped at the mandated 300.3s ceiling after reaching 3%; at least ten failure markers appeared without identities or tracebacks, so this is an unrelated unresolved full-suite boundary and is not attributed to TASK-15742.
