---
id: TASK-26952
title: Clean Ruff formatter debt for ruff-chat-media
status: To Do
assignee: []
...
<!-- TASK-26000-BATCH: ruff-chat-media -->
<!-- TASK-26000-PATHS-SHA256: 252125c30f5b2ed14811d4234bc8986e1f0f5328b69d8922d972ac46e19fbd73 -->
<!-- TASK-26000-FINAL: false -->

## Description

<!-- SECTION:DESCRIPTION:BEGIN -->
Clean the `ruff-chat-media` Ruff formatter batch at the owner boundary recorded as: Chat attachment and media behavior with directly named Chat tests.. The focused test surface recorded by TASK-26000 is `["Tests/Chat", "Tests/Media"]`.
...
```json
[
  "Tests/Chat/test_attachment_local_ingestion_extraction.py"
]
```
