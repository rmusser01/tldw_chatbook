...
Reason: ADR-035 already defines Git index ownership, trust, lifecycle, and UX; ADR-033 governs the process-session owner.
...
8. Run only the approved focused repository/UI/lifecycle/UAT matrix and reconcile TASK-1213.
