...
<!-- SECTION:NOTES:BEGIN -->
STATUS: code-complete, pending Task 9 acceptance run (this task is intentionally left In Progress, not Done -- Task 9 owns the Done transition after an independent acceptance pass).
