...
TASK31773 adjacent RAG settings fullfile exposed one remaining bare-ChatScreen serialization harness lacking settings controller wiring. Added the existing build_console_settings_controllers call before store use in test_source_scope_survives_a_screen_state_round_trip; exact source-scope round-trip assertions retained. Full RAG settings plus retrieval38pass, final combined184pass. This is the same deliberate fail-loud constructor-bypass fixture migration as prior settings ownership repairs.
<!-- SECTION:NOTES:END -->
