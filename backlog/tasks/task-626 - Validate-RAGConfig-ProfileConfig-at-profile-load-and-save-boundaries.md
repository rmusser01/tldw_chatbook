...
Verification: Tests/RAG/ -> 558 passed, 8 skipped (baseline 552/8 + 2 seam-lock tests from task-655 + 4 new task-626 tests). Tests/UI/test_settings_rag_profile_adapter.py + test_settings_rag_profile_region.py -> 181 passed.
<!-- SECTION:NOTES:END -->
