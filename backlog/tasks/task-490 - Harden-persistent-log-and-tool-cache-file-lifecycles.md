...
Reason: Implements ADR-029's accepted private persistent-artifact lifecycle without changing it.
...
Implemented ADR-029's private persistent-artifact lifecycle for rotating
