...
- [ ] #2 Canonical ADR index explains workflow and trigger rules
- [ ] #3 First canonical ADR records this workflow decision
- [ ] #4 Historical ADR-like docs are indexed without migration
- [ ] #5 AGENTS.md requires ADR checks during planning and closeout
- [ ] #6 Documentation verification passes
<!-- AC:END -->
