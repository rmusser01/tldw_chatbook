...
<!-- SECTION:PLAN:BEGIN -->
ADR required: yes
ADR path: backlog/decisions/006-provider-aware-generation-settings.md; backlog/decisions/033-application-session-state-ownership.md
...
ADR required: yes. Existing ADR-006 and ADR-033 apply; no new ADR was needed.
