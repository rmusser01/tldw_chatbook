...
Migration landed 2026-09-19, commit `08ee9c5759` (pushed to `origin/fix/cascade-prep`). TDD red→green throughout: 6 tests failed for the right reasons pre-implementation, all green after.
