...
<!-- SECTION:PLAN:BEGIN -->
Follow approved-console-regressions plan TASK31824: RED actual handler on empty stack, guard before current-screen access, verify empty/matching/stale cases and complete buddy/parallel-run files. ADR required: no; routine late-event lifecycle guard.
<!-- SECTION:PLAN:END -->
