...
ADR required: yes. ADR path: `backlog/decisions/066-checkpoint-harness-process-ownership.md`. Negative harness testing exposed a Darwin process-ownership boundary; ADR-066 records the approved cooperative-subprocess contract, PID-version-safe cleanup, and fail-closed capability gate.
<!-- SECTION:PLAN:END -->
