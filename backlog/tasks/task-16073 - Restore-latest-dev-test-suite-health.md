...
ADR required: no. ADR path: N/A. The task restores existing contracts; any newly discovered architectural decision pauses its cluster for a design/ADR amendment.
<!-- SECTION:PLAN:END -->
