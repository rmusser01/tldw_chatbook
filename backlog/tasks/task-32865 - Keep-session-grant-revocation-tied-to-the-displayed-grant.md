...
Reason: routine UI event-targeting correction under existing permission and design boundaries; no new policy, storage, service contract or application structure.
<!-- SECTION:PLAN:END -->
