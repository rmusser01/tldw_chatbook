...
- [ ] #4 INT8 is selected by default and F32 only when explicit; only artifacts and languages approved by TASK-506 can participate in semantic default routing.
