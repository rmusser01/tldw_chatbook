...
209 P3 findings: naming, comment rot, redundant imports, documented duplication and small consistency defects. None is worth its own pull request, so they are bundled per subsystem. Each task lists its findings and can be closed incrementally.
