...
- Full-player and save-copy acceptance remain open. The live run exposed generated-video persistence/retention defects (TASK-3401.17) and an inline-preview app crash (TASK-3401.18); per this task's contract, those defects were filed separately rather than fixed here.
