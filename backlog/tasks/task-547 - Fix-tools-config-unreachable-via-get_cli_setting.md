...
- [x] Reviewed other `get_cli_setting` calls for the same default-value-slot misuse: found four further live instances, filed as TASK-740, TASK-741, TASK-742 (three subsystems), plus the earlier TASK-658; the bug class itself is tracked by TASK-744
<!-- AC:END -->
