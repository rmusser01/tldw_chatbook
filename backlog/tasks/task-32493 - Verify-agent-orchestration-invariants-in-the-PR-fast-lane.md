...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The existing PR fast lane exercises bounded messaging and capacity, durable budget and runtime-owner migrations, and all session task-store callbacks.
- [ ] #2 The required gate and its dependency boundary remain unchanged; no external provider or full-suite run is added.
<!-- AC:END -->
