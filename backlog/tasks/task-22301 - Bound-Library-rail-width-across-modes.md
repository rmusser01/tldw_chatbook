...
- [ ] #6 Production-styled tests cover the exact projection oracle and box-model input, initial/settled mount, every enumerated route, each adaptive collapse branch, scoped recompose, live resize, custom widths, and specified 235-, 170-, 120-, 100-, 80-, and 60-column geometry states.
