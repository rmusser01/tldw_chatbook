...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Backlog is initialized and post-init smoke checks pass.
- [ ] #2 Canonical roadmap exists and links generated Backlog phase/task IDs.
- [ ] #3 QA evidence structure exists under Docs/superpowers/qa/unified-shell/.
- [ ] #4 Phase 0 QA summary records command evidence and product-QA boundary.
<!-- AC:END -->
