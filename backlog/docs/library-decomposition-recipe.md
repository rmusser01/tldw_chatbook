...
## 24. Keep controller execution payload behind construction (task 31720)

The measurements below describe the original PR-2427 checkpoint. During the
2026-09-08 rebase, dev already deferred both NoteImport and NotesSync imports
inside construction. Keep that implementation and this independent first-use
regression; do not reintroduce an eager NoteImport or duplicate NotesSync import.
...
**Historical checkpoint below.** The 2026-09-08 rebase retains dev's early
MediaState construction and later Ingest/Prompts/MediaController sequence.
Only the same six constructor assignments move to the existing factory;
all six call ASTs still match after self/screen normalization. Current
initialization boundaries supersede the old Skills/preference adjacency.
