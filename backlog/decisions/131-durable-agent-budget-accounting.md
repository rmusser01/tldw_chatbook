...
AgentRunsDB schema v16 adds nullable `agent_runs.budget_tokens`. This preserves
...
The budget column uses v16 because upstream v13-v15 own indexed run steps, spawn-event identity, and optional activity receipts. Automatic work and runtime ownership use v17 and v18 under ADR-135. Existing migrations and their data remain intact; guarded schema detection also accepts historical draft databases containing the same columns under the old numbering. No accounting or authority semantics change.
