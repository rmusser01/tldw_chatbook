# ADR-092: Scoped Full semantic capture policy
...
- ChaChaNotes advances from v50 to v51 through a migration adding queryable exchange
  detail and local conversation capture policy. The implementation rechecked the
  schema head during its final rebase and moved off the now-occupied v50 step.
