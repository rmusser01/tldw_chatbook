...
| [ADR-068](068-console-project-instruction-context-boundary.md) | Accepted | Treat repository `AGENTS.md` files as untrusted, ephemeral, path-aware Console context within one selected workspace folder binding. |
