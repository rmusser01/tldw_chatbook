...
| [ADR-149](149-offer-first-canvas-guide-and-inline-skill.md) | Accepted; written-spec review pending | Offer Canvas before proactive authoring; load bounded packaged guidance in the owning Console run and provide an optional trusted inline skill. |
