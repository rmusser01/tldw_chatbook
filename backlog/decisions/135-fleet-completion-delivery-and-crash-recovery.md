...
AgentRunsDB schema v14 owns the chain, reservation, attempt, and unique source
...
Schema v15 adds a singleton runtime owner fence, updated only by explicit FULL
