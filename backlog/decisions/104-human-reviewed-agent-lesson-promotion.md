# ADR-104: Require foreground approval for Agent Lessons and human review for promotion
...
Extends: [ADR-102](102-portable-notes-organization-and-agent-lessons.md), [ADR-030](030-local-library-agent-tool-boundary.md), [ADR-009](009-local-skill-trust-boundary.md), [ADR-032](032-local-agent-tool-permission-boundary.md), and [ADR-069](069-console-project-instruction-local-state-and-preflight.md)

## Context

ADR-102 keeps Agent Lessons in ordinary user-owned Notes and outside the instruction
authority chain. The approved follow-up design adds two security-sensitive behaviors
that ADR-102 does not decide: every Agent Lesson mutation must receive explicit
...
- [ADR-102: Portable Notes Organization and Agent Lessons](102-portable-notes-organization-and-agent-lessons.md)
