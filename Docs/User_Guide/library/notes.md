...
*Verified against fix/library-notes-w4-data-truth — 2026-09-13 (wave-4 group
...
status line reading "Saved 12:47" beside Info's "Modified 2026-09-13 12:47 ·
just now" at 12:47 PDT / 19:47 UTC, and the stored `last_modified` still
`2026-09-13T19:47:08.754Z` — the conversion is display only
(`wave4-caps/data-truth/data-12-local-clock-status`,
`data-13-info-vs-status-clock`). task-32541: a second **Import once** of an
...
import and is recognised by its content next time; walked live — the second
...
(`data-11-unchanged-repeat-second-import`). task-32538 was investigated and
NOT reproduced: the chrome strip's count was already the open note's — live
"441 words · 1:1" for a 441-word note, then "5,423 words · 1:1" for a 5,423
word / 37 KB note opened straight after it, "5,423 words · 364:1" after
Ctrl+End and "5,427 words · 364:24" after four typed words, at 235x52 and
100x30; critique #3's own captures read "5,404 words · 1:1" and "5,407 words
· 363:22", so the reported "404 words" was the thousands separator dropped in
the reading. The open path is pinned rather than changed
(`data-10-strip-long-note-235x52`, `data-11-strip-100x30`).)*
