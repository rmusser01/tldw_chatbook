...
| `tldw_chatbook/app.py` | 6718, 6738 | App wiring compatibility adapter uses. Semantic matches: `self.server_research_service = ServerResearchService.from_config(`, `ServerResearchSearchService.from_config(`. |
