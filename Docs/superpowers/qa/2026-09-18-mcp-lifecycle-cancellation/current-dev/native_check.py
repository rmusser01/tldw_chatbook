...
def main() -> None:
    """Qualify cancellation in an unused, validated private terminal profile.

    Raises:
        SystemExit: Zero after the journey and app exit succeed, one after a
            captured failure, or two for invalid native runner arguments.
    """
