...
72 distinct targeted cases pass: 11 lifecycle regressions, 55 adjacent lifecycle,
...
All seven preflight guards pass. New test/runner lint and format pass; both large
...
[Lifecycle](native-lifecycle.json) verifies normal App.run return/exit 0, absent
