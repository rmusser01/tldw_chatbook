"""Native journey loaded only after the launcher validates and isolates its profile."""
...
def run(args: Namespace, attempts: list[str]) -> int:
    """Drive the permission-navigation journey in the prepared native terminal.
