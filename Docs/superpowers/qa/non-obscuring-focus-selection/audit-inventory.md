...
| `.sidebar Select:focus` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | select | heavy outline sidebar override | inherit shared thin input focus | PR 5 sidebar focus | shared input contract |
| `.sidebar Input:focus` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | input | heavy outline sidebar override | inherit shared thin input focus | PR 5 sidebar focus | shared input contract |
| `.setting-input:focus` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | input | local focus override needs review | inherit shared thin input focus | PR 5 sidebar focus | shared input contract |
