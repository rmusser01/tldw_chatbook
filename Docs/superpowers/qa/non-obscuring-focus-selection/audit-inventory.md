...
| `.coding-nav-button:focus` | `tldw_chatbook/css/features/_coding.tcss` | Coding | nav button | local focus override needs review | two-cue non-obscuring focus | PR 4 feature focus | source contract |
| `.search-input-enhanced:focus` | `tldw_chatbook/css/features/_search-rag.tcss` | Search/RAG | input | search field focus needs review | thin non-obscuring input focus | PR 4 feature focus | source contract |
| `Input.search-highlight:focus` | `tldw_chatbook/css/features/config_search.tcss` | Config search | input | highlight focus needs review | thin non-obscuring input focus | PR 4 feature focus | source contract |
| `FeatureNotAvailableDialog Button:focus` | `tldw_chatbook/css/features/feature_alerts.tcss` | Feature alert dialog | button | dialog button focus needs review | two-cue non-obscuring focus | PR 4 feature focus | source contract |
...
| `.setting-input:focus` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | input | local focus override needs review | thin non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `.preset-button.active` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | active preset | active fill needs review | selected plus focus contract | Deferred PR 4+ | not yet migrated |
| `.sidebar-resize-button:focus` | `tldw_chatbook/css/layout/_sidebars.tcss` | Legacy sidebars | resize button | tiny button focus needs review | visible non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `Input:focus, TextArea:focus, Select:focus` | `tldw_chatbook/css/features/_ingestion_rebuilt.tcss` | Ingestion rebuilt | mixed inputs | feature-level input focus override | widget-specific non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `Button:focus` | `tldw_chatbook/css/features/_ingestion_rebuilt.tcss` | Ingestion rebuilt | button | feature-level button focus override | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `.media-card:focus` | `tldw_chatbook/css/features/_new_ingest.tcss` | New ingest | card | card focus needs review | non-obscuring focus cue | Deferred PR 4+ | not yet migrated |
...
| `.quick-actions Button:focus` | `tldw_chatbook/css/features/_new_ingest.tcss` | New ingest | button | compact action focus needs review | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `.metadata-grid Input:focus` | `tldw_chatbook/css/features/_new_ingest.tcss` | New ingest | input | feature-level input focus override | thin non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `Button:focus, Input:focus, RadioButton:focus` | `tldw_chatbook/css/features/_new_ingest.tcss` | New ingest | mixed controls | feature-level focus override | widget-specific non-obscuring focus | Deferred PR 4+ | not yet migrated |
...
| `Input:focus, Select:focus, TextArea:focus` | `tldw_chatbook/css/features/_evaluation_unified.tcss` | Evals unified | mixed inputs | feature-level input focus override | widget-specific non-obscuring focus | Deferred PR 4+ | not yet migrated |
...
| `.embeddings-toggle-button-enhanced:focus` | `tldw_chatbook/css/features/_embeddings.tcss` | Embeddings | button | local focus override needs review | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
...
| `.filter-button.active` | `tldw_chatbook/css/features/_embeddings.tcss` | Embeddings | filter button | active fill needs review | active plus focus contract | Deferred PR 4+ | not yet migrated |
| `#tab-dropdown-select:focus` | `tldw_chatbook/css/features/_tab_dropdown.tcss` | Tab dropdown | select | select focus needs review | thin non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `.ingest-nav-pane .ingest-nav-button.active` | `tldw_chatbook/css/features/_ingest.tcss` | Ingest | active nav | active fill needs review | active plus focus contract | Deferred PR 4+ | not yet migrated |
| `.tools-nav-pane .ts-nav-button.active-nav` | `tldw_chatbook/css/features/_tools-settings.tcss` | Tools/settings | active nav | active fill needs review | active plus focus contract | Deferred PR 4+ | not yet migrated |
| `ChatbooksWindowImproved .search-input:focus` | `tldw_chatbook/css/features/_chatbooks_improved.tcss` | Chatbooks | input | feature-level input focus override | thin non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `.keyword-item.selected` | `tldw_chatbook/css/features/_media.tcss` | Media | selected row | selected row needs review | readable selected row | Deferred PR 4+ | not yet migrated |
| `.review-item.selected` | `tldw_chatbook/css/features/_media.tcss` | Media | selected row | selected row needs review | readable selected row | Deferred PR 4+ | not yet migrated |
...
| `BaseTamagotchi:focus` | `tldw_chatbook/Widgets/Tamagotchi/base_tamagotchi.py` | Tamagotchi | custom widget | local focus style needs review | non-obscuring custom focus | Deferred PR 4+ | not yet migrated |
| `EmojiButton.emoji_button:focus` | `tldw_chatbook/Widgets/emoji_picker.py` | Emoji picker | button | compact button focus needs review | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `PathBreadcrumbs .breadcrumb-button:focus` | `tldw_chatbook/Widgets/enhanced_file_picker.py` | File picker | breadcrumb button | compact button focus needs review | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
| `ModelCardViewer .file-item.selected` | `tldw_chatbook/Widgets/HuggingFace/model_card_viewer.py` | HuggingFace model card | selected row | selected row needs review | readable selected row | Deferred PR 4+ | not yet migrated |
