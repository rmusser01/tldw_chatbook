...
| `FeatureNotAvailableDialog Button:focus` | `tldw_chatbook/css/features/feature_alerts.tcss` | Feature alert dialog | button | dialog button focus needs review | two-cue non-obscuring focus | Deferred PR 4+ | not yet migrated |
