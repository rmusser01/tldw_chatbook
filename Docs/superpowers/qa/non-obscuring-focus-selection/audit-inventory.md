...
| `.drop-zone.active` | `tldw_chatbook/css/features/_new_ingest.tcss` | New ingest | active drop zone | active fill needs review | active plus focus/drop contract | PR 17 drop-zone active focus | source contract |
...
| `.step-number.active` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | step indicator | active state needs review | selected plus progress contract | PR 18 wizard progress focus | source and bundled active-state contract |
| `.step-title.active` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | step title | active state needs review | selected plus progress contract | PR 18 wizard progress focus | source and bundled active-state contract |
| `.wizard-step.active` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | step card | active fill needs review | selected plus progress contract | PR 18 wizard progress focus | source and bundled active-state contract |
| `.content-type-card.selected` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | selected card | selected fill needs review | selected plus focus contract | PR 19 wizard selection focus | source and bundled selected-state contract |
| `.preset-card.selected` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | selected card | selected fill needs review | selected plus focus contract | PR 19 wizard selection focus | source and bundled selected-state contract |
| `ProgressStep .status-item.active` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | status row | active row needs review | readable selected row | PR 19 wizard selection focus | source and bundled selected-state contract |
| `ImportProgressStep .status-item.active` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | status row | active row needs review | readable selected row | PR 19 wizard selection focus | source and bundled selected-state contract |
| `SmartContentTree Tree > .selected-node` | `tldw_chatbook/css/features/_wizards.tcss` | Wizards | tree node | selected row needs review | readable selected row | PR 19 wizard selection focus | source and bundled selected-state contract |
...
| `.nav-card:focus` | `tldw_chatbook/UI/Evals/navigation/eval_nav_screen.py` | Evals navigation | card | thick warning focus reads as alert and shifts card geometry | readable non-obscuring card focus | PR 20 evals navigation focus | inline source contract |
