...
The original executable is retired. [Current-dev integration and fresh qualification](current-dev/README.md)
are recorded separately; this section preserves historical evidence only.
...
The [historical runner](https://github.com/rmusser01/tldw_chatbook/blob/5d3e1cb97b029a27d43fd68339e2b6c35b3900a5/Docs/superpowers/qa/2026-09-18-mcp-tool-errors/native_check.py) uses real TldwCli, LinuxDriver, attached TTY streams,
