"""TASK-32776 native workspace Persona identity and complete catalog.
...
def main():
    ...
    async def journey(pilot):
        ...
        try:
            ...
            ids = [f"writer-{i:03}" for i in range(101)] + ["none", "auto"]
            ...
            result["fixture_setup"] = (
                "Real Persona service and registry, 103 saved identities. Tool Profiles initialized first. "
            ...
            for theme in ("textual-dark", "textual-light"):
                for size in ((170, 48), (80, 24)):
                    ...
                    assert set(ids) <= {v for _, v in control._options}
                    ...
                    assert len(personas.list_persona_profiles(limit=1000)) == 103
                    ...
                    assert isinstance(picker, OptionList) and picker.option_count == 103
