...
| oobabooga | oobabooga | oobabooga |  | explicit_model_missing | not_required | api_url; reachable=false; probe=unreachable:URLError; endpoint=http://localhost:5000/v1/chat/completions | skip | endpoint_unreachable | provider-inventory.json; provider-inventory.md |
