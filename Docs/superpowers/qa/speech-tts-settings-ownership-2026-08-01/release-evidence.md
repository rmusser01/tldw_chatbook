...
- Human audible playback proof: Pending TASK-1700
...
| CFG-004 | Automated + UAT | `Tests/UI/test_settings_speech_tts_panel.py::test_panel_exposes_path_pickers_and_no_managed_audio_cpp_controls`; UAT-01 | Automated passing; UAT pending TASK-1700 |
...
| CFG-008 | Automated + UAT | `Tests/UI/test_settings_speech_tts_panel.py::test_credential_operations_are_separate_from_ordinary_save`; UAT-08 | Automated passing; UAT pending TASK-1700 |
...
| CFG-021 | Automated + UAT | `Tests/TTS/test_speech_tts_settings_ownership_hardening.py::test_studio_save_reset_and_preview_preserve_other_owners`; UAT-05 | Automated passing; UAT pending TASK-1700 |
...
| CFG-025 | Automated + UAT | `Tests/UI/test_studio_tts_preferences.py::test_character_profile_is_a_preview_until_explicit_adoption`; UAT-07 | Automated passing; UAT pending TASK-1700 |
...
| STATE-001 | Automated + UAT | `Tests/TTS/test_speech_tts_settings_ownership_hardening.py::test_studio_save_reset_and_preview_preserve_other_owners`; UAT-06 | Automated passing; UAT pending TASK-1700 |
...
| STATE-012 | Automated + UAT | `Tests/UI/test_speech_runtime_status.py::test_external_audio_cpp_readiness_is_independent_of_every_local_dependency`; UAT-10 | Automated passing; UAT pending TASK-1700 |
...
| SEC-002 | Automated + UAT | `Tests/UI/test_settings_speech_tts_panel.py::test_environment_credential_is_read_only_and_editor_starts_empty`; UAT-08 | Automated passing; UAT pending TASK-1700 |
...
| SEC-005 | Manual UAT | UAT-01 | UAT pending TASK-1700 |
...
| STATE-021 | Automated + UAT | `Tests/UI/test_settings_speech_tts_panel.py::test_saved_but_unavailable_and_reconfiguring_are_not_rendered_ready`; UAT-02 | Automated passing; UAT pending TASK-1700 |
...
| A11Y-001 | Automated + UAT | `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_global_and_studio_controls_have_programmatic_labels_and_text_states`; UAT-01 | Automated passing; UAT pending TASK-1700 |
| A11Y-002 | Automated + UAT | `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_keyboard_order_reaches_primary_actions_and_status_does_not_steal_focus`; `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_keyboard_invalid_save_and_dirty_leave_cancel_restore_focus`; UAT-01 | Automated passing; UAT pending TASK-1700 |
...
| A11Y-005 | Automated + UAT | `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_supported_narrow_layout_uses_vertical_scroll_without_clipping_actions`; UAT-01 | Automated passing; UAT pending TASK-1700 |
| A11Y-006 | Automated + UAT | `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_keyboard_order_reaches_primary_actions_and_status_does_not_steal_focus`; `Tests/UI/test_speech_tts_settings_ownership_closeout.py::test_keyboard_invalid_save_and_dirty_leave_cancel_restore_focus`; UAT-02 | Automated passing; UAT pending TASK-1700 |
