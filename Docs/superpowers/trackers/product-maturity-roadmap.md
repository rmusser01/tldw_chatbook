...
| Phase 6 QA index | `Docs/superpowers/qa/product-maturity/phase-6/README.md` | in-progress; TASK-13.1 through TASK-13.3 done |
...
| Phase 6: Release Hardening And Documentation | Reach release-candidate usability. | in-progress; TASK-13.1 through TASK-13.3 done | `TASK-13`, Phase 6.1 (`TASK-13.1`), Phase 6.2 (`TASK-13.2`), Phase 6.3 (`TASK-13.3`), Phase 6.4 (`TASK-13.4`), Phase 6.5 (`TASK-13.5`), Phase 6.6 (`TASK-13.6`), Phase 6.7 (`TASK-13.7`) | `Docs/superpowers/plans/2026-05-16-phase-6-release-hardening.md`; `Docs/superpowers/qa/product-maturity/phase-6/README.md`; `Docs/superpowers/qa/product-maturity/phase-6/2026-05-16-phase-6-2-first-time-user-release-replay.md`; `Docs/superpowers/qa/product-maturity/phase-6/2026-05-16-phase-6-3-power-user-workflow-release-replay.md` | first-time release replay and power-user workflow replay verified. Remaining gates must cover keyboard/focus/accessibility, visual polish, error/recovery copy, packaging, configuration, migration, data-safety, and public roadmap/docs alignment before Phase 6 can close. |
