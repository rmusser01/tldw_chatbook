...
**Decision:** [ADR-033](../../../backlog/decisions/033-application-session-state-ownership.md)
...
**Reason:** Existing ADR-033 remains the applicable decision and no new ADR is
...
- External or internal writes to those names now fail intentionally; ADR-033
...
- ADR-029 private-writer/store tests;
