...
**ADR:** [ADR-092](../../../backlog/decisions/092-console-full-semantic-capture-policy.md)
...
the implemented migration is v50 to v51 after the final `dev` rebase.
...
- Link ADR-092 from TASK-22507, the implementation plan, and closeout notes.
