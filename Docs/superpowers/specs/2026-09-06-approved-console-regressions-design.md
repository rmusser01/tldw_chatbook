...
2. TASK-31822: include visible Redirect in the existing action-row width accounting,
...
3. TASK-31823: add the existing CHAT claimant to the tracked ordinary-resume
...
4. TASK-31824: reject late ContentsRebuilt events when the screen stack is empty
...
5. TASK-31825: classify unsaved synthesized rows in the contiguous leading system
