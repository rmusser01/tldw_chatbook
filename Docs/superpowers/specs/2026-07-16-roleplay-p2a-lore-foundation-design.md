...
- **Byte-compat regression pin** (load-bearing): the scenario corpus above — diagnostics fired-set + injections + tokens == plain `process_messages`, including the disabled-relocation and recursion-dedup edges.
