...
Backlog:
[TASK-488](../../../backlog/tasks/task-488%20-%20Establish-private-path-boundary-and-harden-config-bootstrap.md),
...
regression test keeps the guard owned by TASK-488.
...
1. TASK-488 establishes the dependency-leaf private-path boundary, hardens
...
TASK-489, TASK-490, TASK-491, and TASK-493 depend on TASK-488. TASK-492 depends
...
Reason: ADR-022 already establishes the controlling privacy, filesystem,
