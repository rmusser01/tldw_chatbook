...
**Backlog:** [TASK-654](../../../backlog/tasks/task-654%20-%20Replace-shared-TLDW-API-request-context-with-a-frozen-result-envelope.md)
...
**ADR path:** `backlog/decisions/022-local-private-data-boundary.md`; `backlog/decisions/026-application-session-state-ownership.md`
...
## Task 1: Start TASK-654 and Specify the Frozen Contract
...
## Task 5: Verify and Close TASK-654
...
git commit -m "fix(ingest): bind TLDW API context to worker results (task-654)"
```

- [ ] Re-read TASK-654, add Implementation Notes containing actual commands,
...
git add 'backlog/tasks/task-654 - Replace-shared-TLDW-API-request-context-with-a-frozen-result-envelope.md'
git commit -m "docs(backlog): close TLDW API worker context (task-654)"
```
