...
### Task 1: TASK-31214 — Guided environment, model, network, and command preflight
...
- Modify: `backlog/tasks/task-31214 - Add-guided-vLLM-environment-and-model-preflight.md`
...
- [ ] **Step 1: Put TASK-31214 in progress and attach this plan section**

Run:

```bash
backlog task edit 31214 -a @codex -s "In Progress"
```

Add an Implementation Plan naming this file, ADR-115, the red/green test order below, and:
...
- [ ] **Step 7: Close and commit TASK-31214**
...
### Task 2: TASK-31215 — Generation-fenced API and model readiness
...
- Test: `Tests/UI/test_vllm_lab_workflow.py`
- Modify: `backlog/tasks/task-31215 - Add-generation-fenced-vLLM-API-and-model-readiness.md`
...
- [ ] **Step 1: Start TASK-31215 and copy this section plus ADR-115 rationale into its task file**

Use `backlog task edit 31215 -a @codex -s "In Progress"`; state that no new ADR is required because ADR-115 fixes owner, fencing, privacy, and rollback.
...
- [ ] **Step 6: Close and commit TASK-31215**
...
### Task 3: TASK-31217 — Verified session adoption and Settings delegation
...
- Modify: `backlog/tasks/task-31217 - Adopt-verified-vLLM-targets-into-Console.md`
...
- [ ] **Step 1: Start TASK-31217 and record ADR-115 as the accepted cross-screen contract**
...
- [ ] **Step 7: Close and commit TASK-31217**
...
### Task 4: TASK-31219 — Non-secret profiles and honest restart drafts
...
- Test: `Tests/LLM_Management/test_vllm_connection.py`
- Test: `Tests/UI/test_vllm_lab_workflow.py`
- Modify: `backlog/tasks/task-31219 - Add-current-server-snapshots-and-reusable-vLLM-launch-profiles.md`
...
- [ ] **Step 1: Start TASK-31219 with ADR-115 persistence rationale**
...
- [ ] **Step 7: Close and commit TASK-31219**
...
### Task 5: TASK-31221 — Responsive, keyboard-contained completion and live evidence
...
- Modify: `backlog/tasks/task-31221 - Make-vLLM-setup-responsive-and-keyboard-contained.md`
...
- [ ] **Step 2: Start TASK-31221 and pin the no-new-ADR rationale**

The task implements ADR-115's responsive/focus contract. Add the exact size/state matrix below to its Implementation Plan.
...
- [ ] **Step 8: Self-review against the approved spec and close TASK-31221**
...
- ADR required: no new ADR. ADR-115 is accepted and governs all implementation tasks.
