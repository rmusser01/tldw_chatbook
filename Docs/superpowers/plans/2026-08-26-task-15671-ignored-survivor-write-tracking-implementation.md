...
- [ ] **Step 1: Add one real-tool fence helper**
...
- [ ] **Step 2: Write `test_post_turn_real_write_file_surfaces_a_new_ignored_path`**
...
- [ ] **Step 4: Mutation-check the oracle**
...
- [ ] **Step 1: Write baseline-force RED**
...
- [ ] **Step 3: Add the minimum atomic shadow-snapshot input**
...
- [ ] **Step 4: Reuse one tracker eligibility helper**
...
- [ ] **Step 5: Run baseline and ordinary-turn controls GREEN**
...
- [ ] **Step 6: Write supplied-SHA priming RED**
...
- [ ] **Step 7: Verify supplied-SHA RED**
...
- [ ] **Step 8: Prime without rewriting supplied SHAs**
...
- [ ] **Step 9: Run tracker slice GREEN**
...
- [ ] **Step 10: Commit tracker support**
...
- [ ] **Step 1: Add two lifecycle RED tests**
...
- [ ] **Step 3: Add one mutable state dataclass**
...
- [ ] **Step 6: Capture state references before E**
...
- [ ] **Step 7: Run Task 1 and lifecycle tests GREEN**
...
- [ ] **Step 1: Write the successor-handoff RED matrix**
...
- [ ] **Step 3: Add standard-library boundary state**
...
- [ ] **Step 4: Replace post-B notification with pre-B claim/attach**
...
- [ ] **Step 5: Make close first-owner/waiter safe**
...
- [ ] **Step 6: Preserve inherited state through successor E**
...
- [ ] **Step 7: Run successor tests GREEN**
...
- [ ] **Step 8: Mutation-check handoff and waiter release**
...
- [ ] **Step 1: Remove the named gap outright**
...
- [ ] **Step 2: Run the complete focused module**
...
Expected: task-relevant tests PASS. Current `origin/dev` already fails `Tests/Chat/test_fleet_settle_fanout.py::test_drain_row_is_terminal_at_fire_time_on_the_raise_path_too` because its monkeypatched `_persist` has the stale pre-`durable_handles` signature. Record it as baseline-only unless this branch changes the failure; do not repair that unrelated fixture.
...
- [ ] **Step 5: Review scope and simplicity**
...
- [ ] **Step 1: Update governance and the superseded task hint**
...
- [ ] **Step 2: Add implementation notes and evidence**
...
- [ ] **Step 3: Check all acceptance criteria with Backlog.md**
...
- [ ] **Step 5: Mark Done only after all gates pass**
