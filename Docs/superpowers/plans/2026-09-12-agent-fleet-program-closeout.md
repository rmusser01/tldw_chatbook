...
Current restoration checkpoint: ordinary selected-authority creation, durable ownership/physical completion and confirmed apply/merge/discard are implemented and independently reviewed throughfc9c01473e. The visible Console flow and retained earlier-turn recovery are in progress. There is no external backend prerequisite. Final closure waits for those functional outcomes and the restoration integration review.
