...
- [x] After independent records review and final combined branch review, root checks the parent AC and marks Done through CLI. Verify printed file path and final task content; preserve source/evidence records. No PR/push/merge is implied by this task.
...
Earlier integration checkpoint: partial records review and broad review plus its one correction re-review are approved. TASK18929 and TASK18923 regressions are repaired in 7852cf47ba. The last parent-closure checkbox remained open because TASK31210/31211 worktree recovery was unfinished. See Docs/superpowers/reviews/2026-09-12-agent-orchestration-remaining.md for the retained reviews, targeted evidence and rulings.

Earlier restoration checkpoint: ordinary selected-authority creation, durable ownership/physical completion and confirmed apply/merge/discard are implemented and independently reviewed throughfc9c01473e. The visible Console flow and retained earlier-turn recovery are in progress. There is no external backend prerequisite. Final closure waits for those functional outcomes and the restoration integration review.

Final closure: TASK31210/TASK31211 and parentTASK13154 are Done after the broad restoration review and approved single correction re-review at e135a085f2. All seven actual children remain Done with checked criteria and Implementation Notes. The original historical ancestry evidence was preserved; it was not rerun or presented as fresh provider verification. Targeted tests and static checks support the changed paths with the documented inherited guard/dependency limitations. The complete current evidence/rulings are in Docs/superpowers/reviews/2026-09-12-agent-worktree-restoration.md.
