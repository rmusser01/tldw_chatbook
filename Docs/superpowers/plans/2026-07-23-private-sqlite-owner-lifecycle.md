...
- On Windows, retain the ADR-022 `unverified_platform` posture and current
...
Reason: ADR-022 already requires a checked inventory, pre-created private
...
- [ ] **Step 6: Implement directory and lexical path policy**
  ...
  Use the private-path primitives already accepted by ADR-022. Do not chmod a
...
- [ ] **Step 8: Complete Backlog hygiene**
  ...
  exact verification evidence and ADR-022 linkage, and set TASK-489 to Done
...
- ADR-022, inventory documentation, acceptance criteria, implementation notes,
