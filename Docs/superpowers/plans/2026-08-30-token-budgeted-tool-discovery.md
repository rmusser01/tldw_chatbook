...
> **Completed:** All implementation and closeout steps below were completed for TASK-15261. Steps use checkbox (`- [x]`) syntax as the historical execution record.
...
- [x] **Step 1: Write failing catalog-policy tests**
...
- [x] **Step 2: Write failing search-ranking tests**
...
- [x] **Step 4: Implement the minimal pure primitives**
...
- [x] **Step 6: Commit the catalog policy slice**
...
- [x] **Step 1: Write failing set-level measurement tests**
...
- [x] **Step 2: Write failing first-request decision tests**
...
- [x] **Step 4: Implement shared provider-aware planning**
...
- [x] **Step 5: Wire Console preflight and live primary reuse**
...
- [x] **Step 7: Commit first-request budgeting**
...
- [x] **Step 1: Replace count-era tests with failing replacement tests**
...
- [x] **Step 2: Add failing mixed-batch tests**
...
- [x] **Step 4: Implement minimal exclusive replacement**
...
- [x] **Step 5: Update the model-facing load contract**
...
- [x] **Step 7: Commit runtime replacement**
...
- [x] **Step 1: Write failing service selection tests**
...
- [x] **Step 2: Write failing permission lockstep test**
...
- [x] **Step 4: Implement projected request-fit selection**
...
- [x] **Step 5: Implement lockstep commit and cache invalidation**
...
- [x] **Step 6: Run focused service tests and verify GREEN**

Run: `../../.venv/bin/python -m pytest Tests/Agents/test_agent_service.py Tests/Agents/test_fleet_runtime.py Tests/Chat/test_provider_continuation_crash_recovery.py -q`

- [x] **Step 7: Commit deferred load selection**
...
- [x] **Step 1: Write the failing production-shaped regression**
...
- [x] **Step 3: Rewrite obsolete count pins and normative comments**
...
- [x] **Step 4: Run the complete focused regression shard**
...
- [x] **Step 5: Run static and diff verification**
...
- [x] **Step 6: Self-review against the specification**
...
- [x] **Step 7: Complete task documentation**
