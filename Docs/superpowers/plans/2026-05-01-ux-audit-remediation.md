...
Date: 2026-05-01
Status: Current-dev rebaseline after UX remediation PRs #146-#191, plus active Mindmap compact-control tooltip slice
Branch context: current `origin/dev` at `6c0d2469`; active branch `codex/ux-mindmap-control-tooltips`
...
- Phase 5 Mindmap compact-control tooltips are active in `codex/ux-mindmap-control-tooltips`: dense Mindmap expand/collapse, search, refresh, view-mode, and search-navigation controls explain their action without slowing keyboard users.
