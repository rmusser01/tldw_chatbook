...
Date: 2026-05-01
Status: Current-dev rebaseline after UX remediation PRs #146-#192, plus active SmartContentTree compact-control tooltip slice
Branch context: current `origin/dev` at `de8e58f3`; active branch `codex/ux-smart-content-tree-tooltips`
...
- Phase 5 SmartContentTree compact-control tooltips are active in `codex/ux-smart-content-tree-tooltips`: Chatbook content selection filter and bulk-selection controls explain what visible content they affect.
