...
Date: 2026-05-01
Status: Current-dev rebaseline after UX remediation PRs #146-#194, plus active Embeddings batch-control tooltip slice
Branch context: current `origin/dev` at `fda1973e`; active branch `codex/ux-embeddings-batch-tooltips`
...
- Phase 5 Embeddings batch-control tooltips are active in `codex/ux-embeddings-batch-tooltips`: repeated model/collection selection and deletion controls explain which scope they affect.
