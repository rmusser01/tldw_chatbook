...
- [x] Correct the CI-exposed historical migration fixtures: keep standalone v18 pins, expect the current schema after a full runtime open, and remove v19/v20 shape from the historical seeds. Recheck preservation of records and absent new authority.
