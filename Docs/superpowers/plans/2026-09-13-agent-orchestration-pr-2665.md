...
- [x] Preserve original head08037e50; rebase84 commits onto dev3e28c9e7. Result73fba740 retains upstream run hooks, fork/new-chat disclosure, confirmation state and modular stylesheet loading. Generated diagnostic inventory requires regeneration after source settles.
...
- [ ] Independent final review, apply confirmed corrections, update task/evidence/PR and push with exact force-with-lease. Address all review threads, check fresh dev/check state, merge only after resolved blockers.
