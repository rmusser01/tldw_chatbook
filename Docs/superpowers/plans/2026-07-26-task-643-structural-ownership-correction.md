...
**Reason:** ADR-026 already defines the single runtime authority, projection, persistence, thread-affinity, bootstrap, and coordinated configuration-rebind boundaries. This correction implements the amended decision without a new architectural choice.
