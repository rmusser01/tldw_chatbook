...
- [ ] **Step 1: Write the new-record and legacy RED truth table**
...
- [ ] **Step 3: Add adversarial validation/privacy REDs**
...
- [ ] **Step 1: Write uncapped active-ID RED tests**
...
- [ ] **Step 2: Write coherent snapshot/privacy RED tests**
...
- [ ] **Step 4: Implement the minimal ID query and snapshot boundary**
...
- [ ] **Step 5: Run GREEN and transaction/privacy mutations**
...
- [ ] **Step 1: Write the real ZIP round-trip RED**
...
- [ ] **Step 2: Write all-or-nothing and sanitized failure REDs**
...
- [ ] **Step 3: Write legacy and invalid-import REDs**
...
- [ ] **Step 5: Implement archive-local collection and sanitized settlement**
...
- [ ] **Step 6: Run GREEN and non-vacuity mutations**
...
- [ ] **Step 1: Write scope/count/label RED tests**
...
- [ ] **Step 3: Implement the fourth source without another abstraction**
...
- [ ] **Step 4: Run GREEN and rendered-page bypass mutation**
...
- [ ] **Step 1: Read UI craft guidance immediately before edits**
...
- [ ] **Step 2: Write mounted Prompt-export RED tests**
...
- [ ] **Step 3: Write privacy and 64x24 focus/compositor REDs**
...
- [ ] **Step 5: Implement minimal canvas/screen wiring**
...
- [ ] **Step 6: Run GREEN, mutation checks, and real visual verification**
...
- [ ] **Step 1: Run the integrated Prompt Chatbook matrix**
...
- [ ] **Step 2: Run proportionate regression gates**
...
- [ ] **Step 4: Complete static/security verification**
...
- [ ] **Step 5: Request independent code/spec review**
...
Commit docs/task-only closeout as `docs(prompts): complete task 197 closeout`. Confirm clean status and record final SHAs and evidence. Do not push or open a PR unless separately authorized.
