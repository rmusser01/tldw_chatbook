...
- [x] Write failing source-strip and authority-row tests.
...
- [x] Implement the smallest authority projection.
...
- [x] Pin truthful navigation and compact behavior.
...
- [x] Fix scoped readable error ink and regenerate CSS.
...
- [x] Write failing path-label and state-matrix tests.
...
- [x] Implement layout-only action projection.
...
- [x] Prove focus redirection and compact containment.
...
- [x] Write failing decision-fact placement tests.
...
- [x] Reshape presentation projections without changing domain services.
...
- [x] Restrict technical disclosure to audit evidence.
...
- [x] Verify 40x20 keyboard behavior and commit.
...
- [x] Run all presentation tests together after the three commits.
...
- [x] Complete each Backlog task independently with checked ACs, exact evidence, implementation notes, and its ADR check. Do not defer all three closures to the final programme task.
