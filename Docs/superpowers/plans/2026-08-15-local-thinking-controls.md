...
**Spec:** `Docs/superpowers/specs/2026-08-15-local-thinking-controls-design.md` (argues from ADR-066: `backlog/decisions/066-local-provider-thinking-controls.md`; task: `backlog/tasks/task-17170 - Console-thinking-levels-and-budget-for-local-providers.md`)
...
ls Docs/superpowers/specs/2026-08-15-local-thinking-controls-design.md \
   ...
   "backlog/tasks/task-17170 - Console-thinking-levels-and-budget-for-local-providers.md" \
...
**Files:**
- Modify: `backlog/tasks/task-17170 - Console-thinking-levels-and-budget-for-local-providers.md`
...
```bash
git add "backlog/tasks/task-17170 - Console-thinking-levels-and-budget-for-local-providers.md"
