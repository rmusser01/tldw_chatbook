...
- [x] **Step 5: Root runs new recovery cases and the four affected test files.** Also repeat Task 1's production calculator/Canvas controls to verify recovery integration has not changed healthy sends. Independently review the task and commit only verified changes.
