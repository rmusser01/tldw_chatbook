...
- [x] TASK-32273: DB/service archive lifecycle. Own ChaChaNotes_DB.py, migration, Chat conversation services and DB/Chat tests. Red/green real SQLite, scope pagination and migration checks. Expose `archive_scope`, `set_conversations_archived` and per-ID archive state.
