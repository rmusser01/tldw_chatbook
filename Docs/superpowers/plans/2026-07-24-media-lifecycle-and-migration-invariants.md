...
Date: 2026-07-24
Task: [TASK-495](../../../backlog/tasks/task-495%20-%20Make-media-deletion-and-schema-migrations-preserve-lifecycle-invariants.md)
ADR: [ADR-023](../../../backlog/decisions/023-derived-index-lifecycle-and-atomic-media-migrations.md)
...
8. Run focused database/RAG suites, static analysis, compilation, repository
   ...
   boundaries. Review the resulting diff before closing TASK-495.
...
ADR path:
`backlog/decisions/023-derived-index-lifecycle-and-atomic-media-migrations.md`
