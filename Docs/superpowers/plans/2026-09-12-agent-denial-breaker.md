...
- `tldw_chatbook/Agents/mcp_tool_provider.py`, `local_tool_provider.py`: authoritative invocation decision facts.
...
**Files:** Modify `Chat/console_chat_controller.py` review builders, `Agents/mcp_tool_provider.py`, `Agents/local_tool_provider.py`. Extend new provenance tests, `Tests/Agents/test_mcp_refusal_provenance.py`, `test_local_tool_provider.py`, and existing review-hook tests.
