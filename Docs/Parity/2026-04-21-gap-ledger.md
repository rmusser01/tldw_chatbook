...
- Gap: Evaluation UX adoption, deeper server result-artifact normalization, server target-catalog discovery, and local per-run dataset override/webhook support still need finishing work.
