...
- Current state: Chatbook now has typed direct API-client wrappers plus an app-wired policy-gated server service and source-aware scope seam for server collections feed create, list, detail, update, and delete operations, including returned feed health and schedule metadata. Local/offline mode is explicitly reported as unavailable so this server-owned feed surface does not silently merge with local Watchlists.
- Gap: Dedicated UX adoption, immediate-run status beyond returned job metadata, and local/server subscription mirror semantics remain pending. Local RSS/subscription behavior remains under the Watchlists row and should not be collapsed into server collections feed state.
- Evidence: Server: `../tldw_server/tldw_Server_API/app/api/v1/endpoints/collections_feeds.py`, `../tldw_server/tldw_Server_API/app/api/v1/schemas/collections_feeds_schemas.py`; Chatbook: `tldw_chatbook/Collections_Interop/server_collections_feeds_service.py`, `tldw_chatbook/Collections_Interop/collections_feeds_scope_service.py`, `tldw_chatbook/tldw_api/client.py`, `tldw_chatbook/tldw_api/collections_feeds_schemas.py`, `tldw_chatbook/app.py`; Verification: `Tests/Collections/test_server_collections_feeds_service.py`, `Tests/Collections/test_collections_feeds_scope_service.py`, `Tests/tldw_api/test_collections_feeds_client.py`, app wiring coverage in `Tests/UI/test_screen_navigation.py`, and runtime-policy coverage in `Tests/RuntimePolicy/test_runtime_policy_core.py` / `Tests/RuntimePolicy/test_unsupported_capabilities.py`.
...
- Current state: Chatbook now has typed direct API-client wrappers for server TTS health, STT health, provider/voice catalog discovery, binary speech generation, long-form speech jobs and artifacts, audio job submission/status/SSE progress, TTS history list/detail/favorite/delete, file-based transcription/translation, audio tokenizer JSON/file encode and binary decode, custom voice upload/list/detail/delete/preview plus stored voice reference encoding, and audiobook parse/job/status/artifact/project/chapter/voice-profile/subtitle export operations. Existing local media/TTS behavior remains separate and local-owned.
- Gap: Dedicated audio UX adoption, source-aware audio scope routing, websocket streaming, admin audio-job controls, and local/server audio history or artifact sync semantics remain pending.
- Evidence: Server: `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_tts.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_transcriptions.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_health.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_history.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_jobs.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_tokenizer.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audio_voices.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/audio/audiobooks.py`; Chatbook: `tldw_chatbook/tldw_api/client.py`, `tldw_chatbook/tldw_api/audio_schemas.py`, `tldw_chatbook/tldw_api/audiobook_schemas.py`; Verification: `Tests/tldw_api/test_audio_client.py`, `Tests/tldw_api/test_audiobooks_client.py`.
- Recommended tranche: Tranche 2
...
- Gap: Dedicated UX adoption, source-aware service routing, websocket realtime transport, background ping diagnostics, local Prompt Studio project mirrors, and sync/mirror semantics remain pending. Existing local prompt/evaluation data should stay separate until a deliberate identity bridge is designed.
- Evidence: Server: `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_projects.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_prompts.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_test_cases.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_evaluations.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_optimization.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_status.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/prompt_studio/prompt_studio_websocket.py`; Chatbook: `tldw_chatbook/tldw_api/client.py`, `tldw_chatbook/tldw_api/prompt_studio_schemas.py`; Verification: `Tests/tldw_api/test_prompt_studio_client.py`.
- Recommended tranche: Tranche 3
...
- Requirement class: Local parity required + Remote parity required
- Client obligation: Full CRUD
- Current state: Study seams are already strong across local and server modes, including policy-gated direct server adapters for flashcards/decks/reviews, quizzes/questions/attempts, study-guide generation, and source-scoped unsupported reporting for the local workspace boundary. The typed API client now also covers the broader server flashcards REST contract: deck update/list filters, asset upload/content, card bulk create/update, card detail/update/delete, tags, scheduling reset, structured-QA preview/import, JSON/APKG import, review-session list/end/next-review, study assistant context/respond, AI generation, export, template CRUD, analytics summary, and workspace-aware query passthrough where the server exposes it.
- Gap: Source-aware service adoption for the broader flashcards helpers, dedicated UX, local equivalents for remote-only generation/import/template/assistant/export flows, deck deletion contract handling where the server has no first-class delete route, and local/server identity/sync alignment remain pending. Local mode remains global-only for study decks/reviews and quizzes/attempts; workspace-scoped study is currently a server-mode boundary reported by `StudyScopeService` and `QuizScopeService`.
- Evidence: Server: `../tldw_server/tldw_Server_API/app/api/v1/endpoints/flashcards.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/quizzes.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/chat_documents.py`; Chatbook: `tldw_chatbook/tldw_api/client.py`, `tldw_chatbook/tldw_api/flashcards_schemas.py`, `tldw_chatbook/Study_Interop/local_study_service.py`, `tldw_chatbook/Study_Interop/server_study_service.py`, `tldw_chatbook/Study_Interop/server_quiz_service.py`, `tldw_chatbook/Study_Interop/study_scope_service.py`, `tldw_chatbook/Study_Interop/quiz_scope_service.py`, `tldw_chatbook/UI/Screens/study_screen.py`; Verification: `Tests/tldw_api/test_flashcards_client.py`, `Tests/Study_Interop/test_server_study_service.py`, `Tests/Study_Interop/test_server_quiz_service.py`, `Tests/Study_Interop/test_study_scope_service.py`, and `Tests/Study_Interop/test_quiz_scope_service.py`.
- Recommended tranche: Tranche 1
...
- Requirement class: Remote parity required, local parity optional/deferred
- Client obligation: Full CRUD + Observe
- Current state: Chatbook now has typed direct API-client wrappers for the core Kanban board/list/card REST subset plus non-workflow subresources: labels, comments, checklists and checklist items, content links, board/card activity feeds, basic and enhanced search, board card filtering, board import/export, enhanced card copy, bulk card operations, and bulk link operations.
- Gap: Workflow policy/state controls, source-aware service routing, dedicated UX adoption, and any optional local Kanban model remain pending. Workflow-specific routes are intentionally not implemented in this slice because broader workflows are currently deferred.
- Evidence: Server: `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_boards.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_lists.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_cards.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_labels.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_comments.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_checklists.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_links.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_search.py`, `../tldw_server/tldw_Server_API/app/api/v1/endpoints/kanban/kanban_workflow.py`; Chatbook: `tldw_chatbook/tldw_api/client.py`, `tldw_chatbook/tldw_api/kanban_schemas.py`; Verification: `Tests/tldw_api/test_kanban_client.py` and `Tests/tldw_api/test_kanban_subresources_client.py`.
- Recommended tranche: Tranche 3
