...
Generated images must not be used as 1:1 implementation requirements. If any generated reference conflicts with the text contract or ASCII wireframe, the text contract and ASCII wireframe win.
