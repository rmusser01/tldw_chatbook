...
class UserStatistics:
    ...
    def get_all_stats(self) -> Dict[str, Any]:
        ...
        stats["avg_messages_per_conversation"] = (
            self._get_avg_messages_per_conversation()
        )
    ...
    def _get_main_topics(self, limit: int = 5) -> List[Tuple[str, int]]:
        ...
        try:
            ...
            return sorted(topic_groups.items(), key=lambda x: x[1], reverse=True)[
                :limit
            ]
        except Exception as e:
    ...
    def _get_top_topics_by_message_count(self) -> Dict[str, List[Tuple[str, int]]]:
        ...
        ranges = {"last_100": 100, "last_250": 250, "last_500": 500, "last_1000": 1000}
    ...
    def _get_emoji_usage_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            emoji_rate = (
                round((messages_with_emoji / total_messages * 100), 1)
                if total_messages > 0
                else 0
            )
    ...
    def _get_character_chat_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in cursor.fetchall():
                characters.append(
                    {"name": row[0], "conversations": row[1], "messages": row[2]}
                )
            ...
            return {"total_characters": total_characters, "top_characters": characters}
        except Exception as e:
