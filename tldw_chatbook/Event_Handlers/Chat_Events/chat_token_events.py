...
#
# Local Imports
from ...Utils.token_counter import estimate_remaining_tokens
    ...
    try:
        ...
        try:
            ...
            system_prompt = (
                ...
                if hasattr(system_prompt_widget, "text")
                else ""
            )
...
async def update_chat_token_counter_with_pending(
    app: "TldwCli", pending_text: str
) -> None:
    """
