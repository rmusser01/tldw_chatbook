...
async def handle_ingest_local_web_button_pressed(
...
async def handle_local_pdf_ebook_submit_button_pressed(
    app: "TldwCli", event: "Button.Pressed"
) -> None:
...
async def handle_local_audio_video_submit_button_pressed(
    app: "TldwCli", event: "Button.Pressed"
) -> None:
...
async def handle_local_document_submit_button_pressed(
    app: "TldwCli", event: "Button.Pressed"
) -> None:
...
async def handle_local_plaintext_submit_button_pressed(
    app: "TldwCli", event: "Button.Pressed"
) -> None:
