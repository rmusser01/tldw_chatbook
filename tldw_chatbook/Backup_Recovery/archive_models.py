"""Strict inert recovery manifests; no imported executable policy."""
...
class GroupScope(Record):
    """Installed data-group selection recorded by version-two backups."""

    requested_groups: tuple[Identifier, ...] | None
    effective_groups: tuple[Identifier, ...]
    support_ids: tuple[Identifier, ...]
