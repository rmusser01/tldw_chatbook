...
class EmbeddingTemplateManager:
    ...
    def _load_builtin_templates(self) -> None:
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["Requires API key", "Costs per token", "Requires internet"],
            )
        )
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["Smaller chunks may lose context", "Lower quality embeddings"],
            )
        )
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["Slower processing", "High memory usage", "Large model download"],
            )
        )
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["May not work well for prose", "Specialized chunking"],
            )
        )
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["May need API access", "Variable quality by language"],
            )
        )
        ...
        self.add_template(
            EmbeddingTemplate(
                ...
                cons=["Slower processing", "Large chunks use more memory"],
            )
        )
    ...
    def apply_template(
        self, template_id: str, base_config: Dict[str, Any]
    ) -> Dict[str, Any]:
