    ...
    def _spawn_wave(self):
        ...
        if len(self.waves) < self.max_waves:
            max_radius = math.sqrt(
                (self.display_width / 2) ** 2 + (self.display_height / 2) ** 2
            )
            self.waves.append(
                WaveRippleEffect.Wave(
                    radius=0.0,
    ...
    def update(self) -> Optional[str]:
        ...
        for wave in self.waves:
            ...
            if wave.radius < wave.max_radius:
                ...
                wave.color_index = int(
                    (wave.radius / wave.max_radius) * (len(self.wave_colors) - 1)
                )
        ...
        if self.subtitle:
            ...
            for i, char in enumerate(self.subtitle):
                ...
                if (
                    ...
                    and 0 <= subtitle_y < self.display_height
                ):
