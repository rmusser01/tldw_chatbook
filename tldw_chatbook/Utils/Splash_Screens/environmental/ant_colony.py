...
class AntColonyEffect(BaseEffect):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.food_sources = [(15, 8), (65, 8), (40, 18)]
    ...
    def update(self) -> Optional[str]:
        ...
        for ant in self.ants:
            ...
            if 0 <= ant["x"] < self.width and 0 <= ant["y"] < self.height:
                ant_char = self.ant_chars[
                    hash((ant["x"], ant["y"])) % len(self.ant_chars)
                ]
        ...
        if self.message_progress > 0:
            ...
            for i, letter in enumerate(self.message):
                if (
                    letter in letter_patterns
                    and random.random() < self.message_progress
                ):
