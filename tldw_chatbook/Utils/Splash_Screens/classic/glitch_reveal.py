...
class GlitchRevealEffect(BaseEffect):
    ...
    def update(self) -> Optional[str]:
        ...
        current_intensity = (
            ...
            + (self.end_intensity - self.start_intensity) * progress
        )
        ...
        for line in glitched_lines:
            ...
            if (
                random.random() < current_intensity * 0.5
            ):  # More styling when more intense
                style = random.choice(
                    ["bold red", "bold blue", "bold yellow", "bold magenta"]
                )
