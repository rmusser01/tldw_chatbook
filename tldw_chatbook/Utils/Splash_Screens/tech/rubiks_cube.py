    ...
    def render(self):
        ...
        for i in range(3):
            for j in range(3):
                ...
                if 0 <= x < self.width and 0 <= y < self.height:
                    ...
                    grid[y][x] = "▄"
                    grid[y][x + 1] = "▄"
                    style_grid[y][x] = style_grid[y][x + 1] = self._get_color_style(
                        color
                    )
        ...
        for i in range(3):
            for j in range(3):
                ...
                if 0 <= x < self.width and 0 <= y < self.height:
                    ...
                    if y + 1 < self.height:
                        style_grid[y + 1][x] = style_grid[y + 1][x + 1] = (
                            self._get_color_style(color)
                        )
        ...
        if self.solve_progress > 0.3:
            ...
            if self.solve_progress > 0.7:
                self._add_centered_text(
                    grid, style_grid, "SOLVED!", self.height - 1, "bold green"
                )
