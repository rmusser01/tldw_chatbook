...
class CustomScrapingPipeline(BaseScrapingPipeline):
        ...
        try:
            ...
            if isinstance(item_rule, str):
                ...
                if "conditions" in item_rule:
                    item_elements = self._filter_elements(
                        item_elements, item_rule["conditions"]
                    )
            else:
    ...
    def _parse_item_with_rules(
        self, element, base_url: str, json_ld_data: Dict[str, Any]
        ...
        try:
            ...
            for field_name, rule in self.rules.items():
                ...
                if value and field_name in self.transformations:
                    value = self._apply_transformation(
                        value, self.transformations[field_name]
                    )
            ...
            return ScrapedItem(
                ...
                or self._extract_url(element, base_url),
    ...
    def _check_condition(
        self, item_value: Any, operator: str, condition_value: Any
    ) -> bool:
    ...
    def _build_metadata(
        self, extracted_data: Dict[str, Any], json_ld_data: Dict[str, Any]
    ) -> Dict[str, Any]:
