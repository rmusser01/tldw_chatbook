...
KANBAN_OPERATION_SPECS: dict[str, KanbanOperationSpec] = {
    "create_board": KanbanOperationSpec(
    ...
    "list_boards": KanbanOperationSpec(
        "kanban.boards.list.server", "list_kanban_boards", "board"
    ),
    "get_board": KanbanOperationSpec(
        "kanban.boards.detail.server",
        "get_kanban_board",
        "board",
        identifier_arg_indexes=(0,),
    ),
    "update_board": KanbanOperationSpec(
    ...
    "archive_board": KanbanOperationSpec(
        "kanban.boards.archive.server",
        "archive_kanban_board",
        "board",
        identifier_arg_indexes=(0,),
    ),
    "unarchive_board": KanbanOperationSpec(
        "kanban.boards.restore.server",
        "unarchive_kanban_board",
        "board",
        identifier_arg_indexes=(0,),
    ),
    "delete_board": KanbanOperationSpec(
        "kanban.boards.delete.server",
        "delete_kanban_board",
        "board",
        identifier_arg_indexes=(0,),
    ),
    "restore_board": KanbanOperationSpec(
        "kanban.boards.restore.server",
        "restore_kanban_board",
        "board",
        identifier_arg_indexes=(0,),
    ),
    "create_list": KanbanOperationSpec(
        "kanban.lists.create.server", "create_kanban_list", "list", KanbanListCreate, 1
    ),
    "list_lists": KanbanOperationSpec(
        "kanban.lists.list.server",
        "list_kanban_lists",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "reorder_lists": KanbanOperationSpec(
        "kanban.lists.reorder.server",
        "reorder_kanban_lists",
        "reorder",
        KanbanReorderRequest,
        1,
        (0,),
    ),
    "get_list": KanbanOperationSpec(
        "kanban.lists.detail.server",
        "get_kanban_list",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "update_list": KanbanOperationSpec(
    ...
    "archive_list": KanbanOperationSpec(
        "kanban.lists.archive.server",
        "archive_kanban_list",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "unarchive_list": KanbanOperationSpec(
        "kanban.lists.restore.server",
        "unarchive_kanban_list",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "delete_list": KanbanOperationSpec(
        "kanban.lists.delete.server",
        "delete_kanban_list",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "restore_list": KanbanOperationSpec(
        "kanban.lists.restore.server",
        "restore_kanban_list",
        "list",
        identifier_arg_indexes=(0,),
    ),
    "create_card": KanbanOperationSpec(
        "kanban.cards.create.server", "create_kanban_card", "card", KanbanCardCreate, 1
    ),
    "list_cards": KanbanOperationSpec(
        "kanban.cards.list.server",
        "list_kanban_cards",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "reorder_cards": KanbanOperationSpec(
    ...
    "get_card": KanbanOperationSpec(
        "kanban.cards.detail.server",
        "get_kanban_card",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "update_card": KanbanOperationSpec(
    ...
    "archive_card": KanbanOperationSpec(
        "kanban.cards.archive.server",
        "archive_kanban_card",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "unarchive_card": KanbanOperationSpec(
        "kanban.cards.restore.server",
        "unarchive_kanban_card",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "delete_card": KanbanOperationSpec(
        "kanban.cards.delete.server",
        "delete_kanban_card",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "restore_card": KanbanOperationSpec(
        "kanban.cards.restore.server",
        "restore_kanban_card",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "list_board_activities": KanbanOperationSpec(
        "kanban.activities.list.server",
        "list_kanban_board_activities",
        "activity",
        identifier_arg_indexes=(0,),
    ),
    "list_card_activities": KanbanOperationSpec(
        "kanban.activities.list.server",
        "list_kanban_card_activities",
        "activity",
        identifier_arg_indexes=(0,),
    ),
    "get_board_export": KanbanOperationSpec(
        "kanban.boards.export.server",
        "get_kanban_board_export",
        "board_export",
        identifier_arg_indexes=(0,),
    ),
    "export_board": KanbanOperationSpec(
        "kanban.boards.export.server",
        "export_kanban_board",
        "board_export",
        KanbanBoardExportRequest,
    ...
    "import_board": KanbanOperationSpec(
    ...
    "search_cards_basic": KanbanOperationSpec(
        "kanban.search.list.server",
        "search_kanban_cards_basic",
        "card_search",
        KanbanCardSearchRequest,
        0,
    ),
    "search_cards_basic_get": KanbanOperationSpec(
        "kanban.search.list.server", "search_kanban_cards_basic_get", "card_search"
    ),
    "bulk_move_cards": KanbanOperationSpec(
        "kanban.cards.update.server",
        "bulk_move_kanban_cards",
        "card_bulk",
        KanbanBulkMoveCardsRequest,
        0,
    ),
    "bulk_archive_cards": KanbanOperationSpec(
        "kanban.cards.archive.server",
        "bulk_archive_kanban_cards",
        "card_bulk",
        KanbanBulkArchiveCardsRequest,
        0,
    ),
    "bulk_unarchive_cards": KanbanOperationSpec(
        "kanban.cards.restore.server",
        "bulk_unarchive_kanban_cards",
        "card_bulk",
        KanbanBulkArchiveCardsRequest,
        0,
    ),
    "bulk_delete_cards": KanbanOperationSpec(
        "kanban.cards.delete.server",
        "bulk_delete_kanban_cards",
        "card_bulk",
        KanbanBulkDeleteCardsRequest,
        0,
    ),
    "bulk_label_cards": KanbanOperationSpec(
        "kanban.cards.update.server",
        "bulk_label_kanban_cards",
        "card_bulk",
        KanbanBulkLabelCardsRequest,
        0,
    ),
    "filter_board_cards": KanbanOperationSpec(
        "kanban.cards.list.server",
        "filter_kanban_board_cards",
        "card",
        identifier_arg_indexes=(0,),
    ),
    "copy_card_with_checklists": KanbanOperationSpec(
        "kanban.cards.launch.server",
        "copy_kanban_card_with_checklists",
        "card",
        KanbanCardCopyWithChecklistsRequest,
        1,
        (0,),
    ),
    "create_label": KanbanOperationSpec(
    ...
    "list_labels": KanbanOperationSpec(
        "kanban.labels.list.server",
        "list_kanban_labels",
        "label",
        identifier_arg_indexes=(0,),
    ),
    "get_label": KanbanOperationSpec(
        "kanban.labels.detail.server",
        "get_kanban_label",
        "label",
        identifier_arg_indexes=(0,),
    ),
    "update_label": KanbanOperationSpec(
    ...
    "delete_label": KanbanOperationSpec(
        "kanban.labels.delete.server",
        "delete_kanban_label",
        "label",
        identifier_arg_indexes=(0,),
    ),
    "assign_label_to_card": KanbanOperationSpec(
        "kanban.card_labels.create.server",
        "assign_kanban_label_to_card",
        "card_label",
        identifier_arg_indexes=(0, 1),
    ),
    "remove_label_from_card": KanbanOperationSpec(
        "kanban.card_labels.delete.server",
        "remove_kanban_label_from_card",
        "card_label",
        identifier_arg_indexes=(0, 1),
    ),
    "list_card_labels": KanbanOperationSpec(
        "kanban.card_labels.list.server",
        "list_kanban_card_labels",
        "label",
        identifier_arg_indexes=(0,),
    ),
    "create_checklist": KanbanOperationSpec(
        "kanban.checklists.create.server",
        "create_kanban_checklist",
        "checklist",
        KanbanChecklistCreate,
        1,
    ),
    "list_checklists": KanbanOperationSpec(
        "kanban.checklists.list.server",
        "list_kanban_checklists",
        "checklist",
        identifier_arg_indexes=(0,),
    ),
    "get_checklist": KanbanOperationSpec(
        "kanban.checklists.detail.server",
        "get_kanban_checklist",
        "checklist",
        identifier_arg_indexes=(0,),
    ),
    "update_checklist": KanbanOperationSpec(
        "kanban.checklists.update.server",
        "update_kanban_checklist",
        "checklist",
        KanbanChecklistUpdate,
        1,
        (0,),
    ),
    "delete_checklist": KanbanOperationSpec(
        "kanban.checklists.delete.server",
        "delete_kanban_checklist",
        "checklist",
        identifier_arg_indexes=(0,),
    ),
    "reorder_checklists": KanbanOperationSpec(
        "kanban.checklists.reorder.server",
        "reorder_kanban_checklists",
        "reorder",
        KanbanChecklistReorderRequest,
        1,
        (0,),
    ),
    "create_checklist_item": KanbanOperationSpec(
    ...
    "list_checklist_items": KanbanOperationSpec(
        "kanban.checklist_items.list.server",
        "list_kanban_checklist_items",
        "checklist_item",
        identifier_arg_indexes=(0,),
    ),
    "get_checklist_item": KanbanOperationSpec(
        "kanban.checklist_items.detail.server",
        "get_kanban_checklist_item",
        "checklist_item",
        identifier_arg_indexes=(0,),
    ),
    "update_checklist_item": KanbanOperationSpec(
    ...
    "delete_checklist_item": KanbanOperationSpec(
        "kanban.checklist_items.delete.server",
        "delete_kanban_checklist_item",
        "checklist_item",
        identifier_arg_indexes=(0,),
    ),
    "reorder_checklist_items": KanbanOperationSpec(
        "kanban.checklist_items.reorder.server",
        "reorder_kanban_checklist_items",
        "checklist_item",
        KanbanChecklistItemReorderRequest,
        1,
        (0,),
    ),
    "check_checklist_item": KanbanOperationSpec(
        "kanban.checklist_items.update.server",
        "check_kanban_checklist_item",
        "checklist_item",
        identifier_arg_indexes=(0,),
    ),
    "uncheck_checklist_item": KanbanOperationSpec(
        "kanban.checklist_items.update.server",
        "uncheck_kanban_checklist_item",
        "checklist_item",
        identifier_arg_indexes=(0,),
    ),
    "toggle_all_checklist_items": KanbanOperationSpec(
        "kanban.checklist_items.update.server",
        "toggle_all_kanban_checklist_items",
        "checklist",
        KanbanToggleAllChecklistItemsRequest,
        1,
        (0,),
    ),
    "create_comment": KanbanOperationSpec(
    ...
    "list_comments": KanbanOperationSpec(
        "kanban.comments.list.server",
        "list_kanban_comments",
        "comment",
        identifier_arg_indexes=(0,),
    ),
    "get_comment": KanbanOperationSpec(
        "kanban.comments.detail.server",
        "get_kanban_comment",
        "comment",
        identifier_arg_indexes=(0,),
    ),
    "update_comment": KanbanOperationSpec(
        "kanban.comments.update.server",
        "update_kanban_comment",
        "comment",
        KanbanCommentUpdate,
        1,
        (0,),
    ),
    "delete_comment": KanbanOperationSpec(
        "kanban.comments.delete.server",
        "delete_kanban_comment",
        "comment",
        identifier_arg_indexes=(0,),
    ),
    "search_cards_get": KanbanOperationSpec(
        "kanban.search.list.server", "search_kanban_cards_get", "search"
    ),
    "search_cards": KanbanOperationSpec(
        "kanban.search.list.server",
        "search_kanban_cards",
        "search",
        KanbanSearchRequest,
    ...
    "get_search_status": KanbanOperationSpec(
        "kanban.search.detail.server",
        "get_kanban_search_status",
        "search_status",
        identifier_arg_indexes=(),
    ),
    "add_card_link": KanbanOperationSpec(
        "kanban.card_links.create.server",
        "add_kanban_card_link",
        "card_link",
        KanbanCardLinkCreate,
        1,
    ),
    "list_card_links": KanbanOperationSpec(
        "kanban.card_links.list.server",
        "list_kanban_card_links",
        "card_link",
        identifier_arg_indexes=(0,),
    ),
    "get_card_link_counts": KanbanOperationSpec(
        "kanban.card_links.detail.server",
        "get_kanban_card_link_counts",
        "card_link_counts",
        identifier_arg_indexes=(0,),
    ),
    "remove_card_link": KanbanOperationSpec(
        "kanban.card_links.delete.server",
        "remove_kanban_card_link",
        "card_link",
        identifier_arg_indexes=(0, 1, 2),
    ),
    "remove_card_link_by_id_for_card": KanbanOperationSpec(
        "kanban.card_links.delete.server",
        "remove_kanban_card_link_by_id_for_card",
        "card_link",
        identifier_arg_indexes=(0, 1),
    ),
    "remove_card_link_by_id": KanbanOperationSpec(
        "kanban.card_links.delete.server",
        "remove_kanban_card_link_by_id",
        "card_link",
        identifier_arg_indexes=(0,),
    ),
    "bulk_add_card_links": KanbanOperationSpec(
        "kanban.card_links.create.server",
        "bulk_add_kanban_card_links",
        "card_link_bulk",
        KanbanBulkCardLinksRequest,
        1,
        (0,),
    ),
    "bulk_remove_card_links": KanbanOperationSpec(
        "kanban.card_links.delete.server",
        "bulk_remove_kanban_card_links",
        "card_link_bulk",
        KanbanBulkCardLinksRequest,
        1,
        (0,),
    ),
    "list_cards_by_linked_content": KanbanOperationSpec(
        "kanban.card_links.list.server",
        "list_kanban_cards_by_linked_content",
        "linked_cards",
        identifier_arg_indexes=(0, 1),
    ),
}
...
class ServerKanbanService:
        ...
        if callable(require_ui_action_allowed):
            ...
            if decision is not None and getattr(decision, "allowed", True) is False:
                raise PolicyDeniedError(
                    ...
                    or "Server Kanban action is not allowed.",
    ...
    def _coerce_request_args(
        ...
        if spec.request_arg_index < len(args):
            next_args = list(args)
            next_args[spec.request_arg_index] = cls._model(
                next_args[spec.request_arg_index], spec.request_model
            )
            return tuple(next_args), kwargs
        if "request_data" in kwargs:
            next_kwargs = dict(kwargs)
            next_kwargs["request_data"] = cls._model(
                next_kwargs["request_data"], spec.request_model
            )
            return args, next_kwargs
        return args, kwargs

    @staticmethod
    def _identifier_from_args(
        args: tuple[Any, ...], spec: KanbanOperationSpec
    ) -> str | None:
    ...
    def _with_record_id(
        ...
        if identifier is None:
            identifier = (
                ...
                or record.get("board_id")
                or record.get("list_id")
            )
    ...
    def _normalize_record(
        ...
        *,
        ...
        if isinstance(payload, list):
            return [
                cls._normalize_record(item, kind=kind, identifier=identifier)
                for item in payload
            ]
        if not isinstance(payload, dict):
            if kind is not None:
                return cls._with_record_id(
                    cls._record_kind_name(kind), {"success": bool(payload)}, identifier
                )
            return payload

        record = {
            key: cls._normalize_collection_value(key, value)
        ...
        if record_kind is not None:
            if kind == "board_import":
                identifier = (
                    identifier
                    or record.get("import_stats", {}).get("board_id")
                    or record.get("board", {}).get("id")
                )
    ...
    def _normalize_collection_value(cls, key: str, value: Any) -> Any:
        ...
        if isinstance(value, dict):
            return {
                nested_key: cls._normalize_collection_value(nested_key, nested_value)
    ...
    async def invoke(self, operation_name: str, *args: Any, **kwargs: Any) -> Any:
        ...
        coerced_args, coerced_kwargs = self._coerce_request_args(
            args, dict(kwargs), spec
        )
        result = await getattr(self._require_client(), spec.client_method)(
            *coerced_args, **coerced_kwargs
        )
