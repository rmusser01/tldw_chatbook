...
SCREEN_OWNED_SPLITS: tuple[ScreenOwnedSplit, ...] = (
    ...
    # TASK-31932: defer only Lab-prefixed rules, shared by Models/Speech/Evals.
    # Owner audit 2026-09-13: all 13 moved tokens traced with repo-relative
    # paths to LabScreen/LabModeStrip/LabWorkbench and their three routes.
    # An owner filter matching no files flags all 12 literal-hit tokens;
    # lab-mode-evals is generated by LabScreen's lab-mode-{screen_name}.
    # Shared is-active/workbench/evals/speech selectors stay in the bundle.
    ScreenOwnedSplit(
        module="features/_lab.tcss",
        sheets={"lab": "screen_feature_lab.tcss"},
        prefixes={"lab": ("lab",)},
        pinned=frozenset(),
    ),
