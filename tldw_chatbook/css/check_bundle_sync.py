...
def main() -> int:
    ...
    defaults_names = (
        ...
        # TASK-25812/TASK-24459: the per-screen sheets split from the
        # screen-owned modules (agentic terminal, evals, scheduling).
        # Generated by the same build, so they drift the same way.
        *(
            filename
            for split in _build_css.SCREEN_OWNED_SPLITS
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            with contextlib.redirect_stdout(io.StringIO()):
                ...
                _build_css.build_screen_owned_sheets(css_dir, Path(tmp))
