...
_LOCAL_UNSUPPORTED_CAPABILITIES = [
    ...
    },
    {
        ...
        "supported": False,
        "reason_code": "source_specific_equivalent",
        "user_message": "The server process-web-scraping endpoint is server-owned; local mode should use local URL ingestion or scraping tooling instead.",
        "affected_action_ids": [],
    },
    {
        ...
        "supported": False,
        "reason_code": "source_specific_equivalent",
        "user_message": "The server MediaWiki dump processing endpoints are server-owned; local mode should use local ingestion tooling instead.",
        "affected_action_ids": [],
    },
    {
