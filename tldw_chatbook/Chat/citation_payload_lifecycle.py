        ...
        *,
        ...
        affected_trace_ids = tuple(
            ...
            for row in cursor.execute(
                ...
                ORDER BY trace_id
                """,
                (tombstone.profile_id, snapshot_payload_id),
            ).fetchall()
        )
        ...
        *,
        ...
        with self.repository.db.transaction() as cursor:
            ...
            candidates = cursor.execute(
                ...
                LIMIT ?
                """,
                (identity.profile_id, batch_limit),
            ).fetchall()
            ...
            expired_tombstones = cursor.execute(
                """
                ...
                LIMIT ?
                """,
                (identity.profile_id, current_time.isoformat(), batch_limit),
            ).fetchall()
