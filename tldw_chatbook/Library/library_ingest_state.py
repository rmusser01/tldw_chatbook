...
_GLYPH_MATCHED = "≡"
_GLYPH_FAILED = "✗"  # "✗"
from tldw_chatbook.Library.library_shell_state import LIBRARY_GLYPH_OUTCOME_SKIPPED as _GLYPH_SKIPPED  # "–": a settled outcome, never a disabled control (task-32235; was "○", task-2220)
