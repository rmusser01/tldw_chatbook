...
class TranscriptionHistory:
    ...
    def __init__(self, history_file: Optional[Path] = None):
        ...
        self.auto_delete_days = get_cli_setting(
            "dictation.privacy.auto_delete_days", 30
        )
        ...
        try:
            ...
            if data.get("encrypted", False):
                ...
                decrypted = self.encryption.decrypt_value(
                    encrypted_content, self._password
                )
    ...
    def save(self, encrypt: bool = True) -> bool:
        ...
        try:
            ...
            if encrypt and self._password:
                ...
                encrypted = self.encryption.encrypt_value(content_json, self._password)
    ...
    def get_entries(
        ...
        if search:
            ...
            entries = [e for e in entries if search_lower in e.transcript.lower()]
    ...
    def _clean_old_entries(self):
        ...
        self._entries = [
            e for e in self._entries if e.timestamp.timestamp() > cutoff_date
        ]
    ...
    def _export_as_csv(self, entries: List[TranscriptionEntry]) -> str:
        ...
        # Header
        writer.writerow(
            ["Timestamp", "Duration", "Words", "Language", "Provider", "Transcript"]
        )
