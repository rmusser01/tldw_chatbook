...
from tldw_chatbook.Sharing.server_sharing_scope_service import ServerSharingScopeService
from tldw_chatbook.Sharing.server_sharing_service import ServerSharingService
...
class TldwCli(App[None]):  # Specify return type for run() if needed, None is common
    ...
    def __init__(self):
        ...
        try:
            self.server_sharing_service = ServerSharingService.from_config(self.app_config)
        except ValueError:
            self.server_sharing_service = ServerSharingService(client=None)
        self.server_sharing_scope_service = ServerSharingScopeService(
