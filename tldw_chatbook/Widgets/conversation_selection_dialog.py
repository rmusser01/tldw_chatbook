    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(classes="conversation-item"):
            ...
            with Vertical(classes="conversation-details"):
                yield Label(
                    self.title or "Untitled Conversation", classes="conversation-title"
                )
                yield Static(
...
class ConversationSelectionDialog(ModalScreen[Optional[Dict[str, Any]]]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="conversation-selection-container"):
            yield Label(
                "Select Conversation for Audio Generation", classes="dialog-title"
            )
                ...
                with Horizontal(classes="form-row"):
                    ...
                    with Vertical():
                        yield RadioSet(
                            ...
                            RadioButton(
                                "Assistant messages only", id="include-assistant"
                            ),
                            id="include-options",
                        )
