...
class TamagotchiInteraction(TamagotchiMessage):
    ...
    def __init__(
        self, tamagotchi: "BaseTamagotchi", action: str, result: Dict[str, Any]
    ) -> None:
        """
...
class TamagotchiStateChange(TamagotchiMessage):
    ...
    def __init__(
        self, tamagotchi: "BaseTamagotchi", old_state: str, new_state: str
    ) -> None:
        """
...
class TamagotchiEvolution(TamagotchiMessage):
    ...
    def __init__(
        self, tamagotchi: "BaseTamagotchi", from_stage: str, to_stage: str
    ) -> None:
        """
