...
class LibraryMediaTrashCanvas(PostRecomposeCallback, RecomposeCaptureGuard, Vertical):
    ...
    def compose(self) -> ComposeResult:
        ...
        if bounded:
            ...
            with filters:
                if self.type_choices_visible:
                    ...
                    choices.set_styles(width="100%")
                    choices.set_styles(height=1)
                    ...
                    search.set_styles(width="1fr")
                    search.styles.min_width = 5
                    search.set_styles(height=1)
                    search.styles.min_height = 1
                    search.set_styles(padding=0)
                    search.set_styles(border=("none", "transparent"))
                    ...
                    scope.set_styles(width="auto")
                    scope.styles.max_width = 28
                    scope.set_styles(height=1)
                    yield scope
        else:
        ...
        trash_list.set_styles(height="auto")
        ...
        if self.confirmation_target is not None:
            ...
            with confirmation:
                ...
                consequence.set_styles(height=1)
                ...
                with identity:
                    ...
                    type_identity.set_styles(height=1)
                    ...
                    time_identity.set_styles(height=1)
        ...
        with toolbar:
            ...
            restore.set_styles(padding=0)
            restore.set_styles(margin=0)
            yield restore
            if bounded:
                delete = Button(
