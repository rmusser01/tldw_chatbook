...
class AudioTroubleshootingDialog(ModalScreen[bool]):
            ...
            with ScrollableContainer():
                ...
                with Collapsible(title="📊 Input Level", collapsed=False):
                    ...
                    with Container(classes="test-controls"):
                        yield Button(
                            "Start Test", id="test-start-btn", variant="primary"
                        )
                        yield Button("Stop Test", id="test-stop-btn", disabled=True)
        ...
        try:
            ...
            try:
                ...
                if self.audio_devices:
                    ...
                    log.write(
                        f"[green]Found {len(self.audio_devices)} audio devices[/green]"
                    )
                else:
    ...
    def _start_level_test(self):
        ...
        self._level_update_task = self.set_interval(0.1, self._update_level_meter)
    ...
    def _apply_and_close(self):
        ...
        if self.selected_device is not None:
            ...
            save_setting_to_cli_config(
                "dictation", "preferred_device_id", self.selected_device
            )
