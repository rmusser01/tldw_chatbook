...
from textual.widgets import Button, Label, Static, Input, ListView, ListItem
from textual.containers import Container, Horizontal, Vertical, VerticalScroll
from textual.reactive import reactive
from loguru import logger

from .eval_shared_components import BaseEvaluationWindow
from ..Event_Handlers.eval_events import get_available_datasets, get_dataset_info
...
class DatasetListItem(ListItem):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(classes="dataset-list-item"):
            ...
            yield Static(
                f"({self.dataset_info.get('size', 0)} samples)", classes="dataset-size"
            )
...
class DatasetManagementWindow(BaseEvaluationWindow):
        ...
        with Horizontal(classes="dataset-management-layout"):
            ...
            with Vertical(classes="dataset-list-panel"):
                ...
                with VerticalScroll(classes="dataset-list-container"):
                    yield ListView(id="dataset-list", classes="dataset-list")
            ...
            with Vertical(classes="dataset-preview-panel"):
                ...
                with Container(classes="dataset-info-section"):
                    ...
                    yield Static(
                        "Select a dataset", id="dataset-name", classes="info-value"
                    )
    ...
    def _update_dataset_list(self) -> None:
        ...
        if self.search_query:
            ...
            filtered_datasets = [d for d in self.datasets if query in d["name"].lower()]
    ...
    async def handle_validate_dataset(self) -> None:
        ...
        self.notify(
            f"Validating {self.selected_dataset['name']}...", severity="information"
        )
