"""Media Ingestion Screen with tabbed interface."""
...
class MediaIngestScreen(Screen):
    """Main media ingestion screen with tabbed navigation for different media types."""
    ...
    def __init__(self, app_instance: 'TldwCli', **kwargs):
        ...
        logger.debug("MediaIngestScreen initialized")
    ...
    def on_mount(self):
        """Handle mount event."""
        logger.info("MediaIngestScreen mounted")
