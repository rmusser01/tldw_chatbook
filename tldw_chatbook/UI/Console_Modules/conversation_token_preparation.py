...
async def prepare_conversation_tokens(
    ...
    selection = screen._provider_selection._build_console_provider_selection(session_id)
    rows = tuple(
    ...
    if (
        ...
        or screen._provider_selection._build_console_provider_selection(session_id)
        != selection
    ):
