...
class ConsoleInspectorRail(Vertical):
    ...
    * body ``scroll_y`` change: wheel, keys, ``scroll_to``, reveal — pure
    ...
    def compose(self) -> ComposeResult:
        ...
        right_rail_header.set_styles(height=1)
        ...
        project_instruction_row.set_styles(width="100%")
        project_instruction_row.set_styles(height=1)
        ...
        with _InspectorOuterBody(
            ...
            staged_context_tray.set_styles(width="100%")
            staged_context_tray.styles.min_width = 0
            staged_context_tray.set_styles(height="auto")
            ...
            retrieval_scope_row.set_styles(width="100%")
            retrieval_scope_row.styles.min_width = 0
            retrieval_scope_row.set_styles(height="auto")
            ...
            with Vertical(id="console-run-inspector"):
                ...
                settings_summary.set_styles(width="100%")
