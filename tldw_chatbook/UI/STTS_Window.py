...
class TTSPlaygroundWidget(
    SpeechSynthesisMixin, SpeechCatalogMixin, SpeechPlaybackMixin, Widget
):
    @on(Select.Changed)
    def on_tts_provider_select_changed(self, event: Select.Changed) -> None:
        ...
        Args:
            event: Any Select change in this widget.
        """
        self.handle_provider_select_changed(event)

    def _tts_service_factory(self):
        """Resolve the service from this module, where tests patch it.
    ...
    def _cli_setting(self, *args, **kwargs):
        """Resolve the setting reader from this module, where tests patch it.
