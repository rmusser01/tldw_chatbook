...
from ..Constants import TAB_CCP, TAB_TOOLS_SETTINGS, TAB_INGEST, TAB_LLM, TAB_EVALS, TAB_CODING, TAB_STTS, TAB_STUDY # Added import
#
#######################################################################################################################
#
# Functions:
    ...
    def compose(self) -> ComposeResult:
        with HorizontalScroll(id="tabs"):  # Inner scrollable area
            for tab_id_loop in self.tab_ids:
                ...
                elif tab_id_loop == TAB_EVALS:
                    label_text = "Evals"
                elif tab_id_loop == TAB_CODING:
                    label_text = "Coding"
                elif tab_id_loop == TAB_STTS:
                    label_text = "S/TT/S"
                elif tab_id_loop == TAB_STUDY:
                    label_text = "Study"
                else:
