...
class ChatAttachmentMessage(ChatMessage):
    ...
    class FileProcessed(ChatMessage):
        ...
        def __init__(
            self, file_path: Path, result: Dict[str, Any], session_id: str = "default"
        ) -> None:
    ...
    class FileError(ChatMessage):
        ...
        def __init__(
            self, file_path: Path, error: str, session_id: str = "default"
        ) -> None:
...
class ChatVoiceMessage(ChatMessage):
    ...
    class TranscriptReceived(ChatMessage):
        ...
        def __init__(
            self, text: str, is_final: bool = False, session_id: str = "default"
        ) -> None:
...
class ChatSidebarMessage(ChatMessage):
    ...
    class SidebarToggled(ChatMessage):
        ...
        def __init__(
            self, sidebar_id: str, visible: bool, session_id: str = "default"
        ) -> None:
    ...
    class CharacterLoaded(ChatMessage):
        ...
        def __init__(
            self, character_id: str, character_data: Dict, session_id: str = "default"
        ) -> None:
    ...
    class PromptSelected(ChatMessage):
        ...
        def __init__(
            self, prompt_id: str, prompt_text: str, session_id: str = "default"
        ) -> None:
...
class ChatMessageDisplayMessage(ChatMessage):
    ...
    class MessageAdded(ChatMessage):
        ...
        def __init__(
            self, message_id: str, content: str, role: str, session_id: str = "default"
        ) -> None:
    ...
    class MessageUpdated(ChatMessage):
        ...
        def __init__(
            self, message_id: str, new_content: str, session_id: str = "default"
        ) -> None:
...
class ChatStreamingMessage(ChatMessage):
    ...
    class StreamChunk(ChatMessage):
        ...
        def __init__(
            self, message_id: str, chunk: str, session_id: str = "default"
        ) -> None:
    ...
    class StreamCompleted(ChatMessage):
        ...
        def __init__(
            self, message_id: str, final_content: str, session_id: str = "default"
        ) -> None:
    ...
    class StreamError(ChatMessage):
        ...
        def __init__(
            self, message_id: str, error: str, session_id: str = "default"
        ) -> None:
