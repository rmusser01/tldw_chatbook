...
class ChatMessageManager:
    ...
    async def add_message(self, content: str, role: str = "user", **kwargs):
        ...
        message = ChatMessageEnhanced(content=content, role=role, **kwargs)
    ...
    def get_messages_by_role(
        self, role: str
    ) -> List[Union["ChatMessage", "ChatMessageEnhanced"]]:
        ...
        all_messages = self.get_all_messages()
        return [
            msg for msg in all_messages if hasattr(msg, "role") and msg.role == role
        ]
