...
CHUNK_METHODS = ['words', 'sentences', 'paragraphs', 'tokens', 'semantic', 'json', 'xml', 'ebook_chapters',
                 'rolling_summarize']
                ...
                with Container(classes="embeddings-action-container"):
                    with Horizontal(classes="embeddings-button-row"):
                        ...
                        yield Button("Preview Chunks", id="embeddings-preview", classes="embeddings-action-button",
                                     variant="warning")
                        yield Button("Create Embeddings", id="embeddings-create", classes="embeddings-action-button",
                                     variant="primary")
    ...
    def _compose_processing_tab(self) -> ComposeResult:
        ...
        with VerticalScroll(classes="embeddings-tab-scroll"):
            ...
            with Collapsible(title="Advanced Options", id="embeddings-advanced-options",
                             classes="embeddings-form-section"):
                with Horizontal(classes="embeddings-form-row"):
