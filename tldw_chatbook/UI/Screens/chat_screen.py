...
class ChatScreen(BaseAppScreen):
    ...
    _console_model_option_warnings = _ControllerState("_provider_selection", "_console_model_option_warnings")
    ...
    def action_open_console_session_settings(self) -> None:
        ...
        if self._console_setup_modal_blocking():
            return
        self.run_worker(
            self._open_console_settings(), exclusive=False
        )
    ...
    async def _providers_models_for_console_settings(
        ...
        *,
        ...
        return await self._provider_selection._providers_models_for_console_settings(provider, current_model=current_model)
