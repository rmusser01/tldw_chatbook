...
class SchedulesWorkbench(BaseAppScreen):
    ...
    #: TASK-24459: scheduling-owned rules split out of
    #: ``features/_scheduling.tcss``, parsed on first visit instead of
    #: before first paint. GENERATED by ``css/build_css.py``.
    CSS_PATH = [
        str(
