...
class NewTaskChoiceModal(SafeModalDismissMixin, ModalScreen[NewTaskChoice | None]):
    ...
    NewTaskChoiceModal .new-task-choice-actions Button.new-task-choice-modal-button {
        width: auto;
        margin-left: 1;
    }
    """
    ...
    def compose(self) -> ComposeResult:
        with Vertical(classes="new-task-choice-modal"):
            yield Static(
                "New scheduled task", classes="new-task-choice-title", markup=False
            )
            yield Static(
            ...
            with Horizontal(classes="new-task-choice-actions"):
                yield Button(
                    ...
                    classes="new-task-choice-modal-button",
                )
                yield Button(
                    "Recurring question…",
