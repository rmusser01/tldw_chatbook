...
class ConversationMessage(CCPMessage):
    ...
    class Selected(CCPMessage):
        ...
        def __init__(
            self, conversation_id: EntityId, title: str, sender: Any = None
        ) -> None:
    ...
    class SearchRequested(CCPMessage):
        ...
        def __init__(
            self, search_term: str, search_type: str = "title", sender: Any = None
        ) -> None:
            super().__init__(sender)
...
class CharacterMessage(CCPMessage):
    ...
    class Selected(CCPMessage):
        ...
        def __init__(
            self, character_id: EntityId, name: str, sender: Any = None
        ) -> None:
            super().__init__(sender)
    ...
    class Loaded(CCPMessage):
        ...
        def __init__(
            self, character_id: EntityId, card_data: Dict[str, Any], sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.character_id = character_id
    ...
    class ExportRequested(CCPMessage):
        ...
        def __init__(
            self, character_id: EntityId, file_path: str, sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.character_id = character_id
            self.file_path = file_path
    ...
    class GenerateFieldRequested(CCPMessage):
        ...
        def __init__(
            self, field_name: str, context: Dict[str, Any], sender: Any = None
        ) -> None:
            super().__init__(sender)
...
class PersonaMessage(CCPMessage):
    ...
    class Loaded(CCPMessage):
        ...
        def __init__(
            self, persona_id: str, persona_data: Dict[str, Any], sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.persona_id = persona_id
...
class PromptMessage(CCPMessage):
    ...
    class Loaded(CCPMessage):
        ...
        def __init__(
            self, prompt_id: EntityId, prompt_data: Dict[str, Any], sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.prompt_id = prompt_id
...
class DictionaryMessage(CCPMessage):
    ...
    class EntryAdded(CCPMessage):
        ...
        def __init__(
            self, dictionary_id: int, entry_data: Dict[str, Any], sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.dictionary_id = dictionary_id
    ...
    class EntryRemoved(CCPMessage):
        ...
        def __init__(
            self, dictionary_id: int, entry_key: str, sender: Any = None
        ) -> None:
            super().__init__(sender)
            self.dictionary_id = dictionary_id
...
class SidebarMessage(CCPMessage):
    ...
    class CollapsibleToggled(CCPMessage):
        ...
        def __init__(
            self, section_id: str, collapsed: bool, sender: Any = None
        ) -> None:
            super().__init__(sender)
