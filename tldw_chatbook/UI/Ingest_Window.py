...
class IngestWindow(Container):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="ingest-content-pane", classes="ingest-content-pane"):
            ...
            with Container(id="ingest-view-local-web", classes="ingest-view-area"):
                with VerticalScroll():
                    # URL Input Section
    ...
    # NOTE: compose_local_web_article_tab is no longer used - content has been inlined into the main compose method
    # def compose_local_web_article_tab(self) -> ComposeResult:
    #     """Composes the Web Article tab content for local media ingestion."""
    #     # Content has been moved to the main compose method to match the LLM Management Window pattern
