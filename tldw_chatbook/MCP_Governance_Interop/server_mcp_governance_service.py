...
class ServerMCPGovernanceService:
        ...
        if callable(require_ui_action_allowed):
            ...
            if decision is not None and getattr(decision, "allowed", True) is False:
                raise PolicyDeniedError(
                    ...
                    or "Server MCP governance action is not allowed.",
    ...
    @staticmethod
    def _model(
        request_data: TModel | dict[str, Any], model_type: type[TModel]
    ) -> TModel:
    ...
    async def preview_capability_mapping(
        self, request_data: MCPCapabilityMappingCreate | dict[str, Any]
    ) -> dict[str, Any]:
        ...
        return self._dump(
            await self._require_client().preview_mcp_capability_mapping(request)
        )
    ...
    async def create_capability_mapping(
        ...
        request = self._model(request_data, MCPCapabilityMappingCreate)
        return self._dump(
            await self._require_client().create_mcp_capability_mapping(request)
        )
    ...
    async def update_capability_mapping(
        ...
        return self._dump(
            await self._require_client().update_mcp_capability_mapping(
                capability_adapter_mapping_id, request
            )
        )
    ...
    async def delete_capability_mapping(
        ...
        return self._dump(
            await self._require_client().delete_mcp_capability_mapping(
    ...
    async def create_external_server(
        self, request_data: MCPExternalServerCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_external_server(request)
        )

    async def import_external_server(self, server_id: str) -> dict[str, Any]:
        self._enforce("mcp.governance.external_servers.create.server")
        return self._dump(
            await self._require_client().import_mcp_external_server(server_id)
        )
    ...
    async def update_external_server(
        ...
        return self._dump(
            await self._require_client().update_mcp_external_server(server_id, request)
        )
    ...
    async def delete_external_server(self, server_id: str) -> dict[str, Any]:
        ...
        return self._dump(
            await self._require_client().delete_mcp_external_server(server_id)
        )

    async def set_external_server_secret(
        self, server_id: str, request_data: MCPSecretSetRequest | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().set_mcp_external_server_secret(
                server_id, request
            )
        )
    ...
    async def create_permission_profile(
        self, request_data: MCPPermissionProfileCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_permission_profile(request)
        )
    ...
    async def update_permission_profile(
        ...
        return self._dump(
            await self._require_client().update_mcp_permission_profile(
                profile_id, request
            )
        )
    ...
    async def delete_permission_profile(self, profile_id: int) -> dict[str, Any]:
        ...
        return self._dump(
            await self._require_client().delete_mcp_permission_profile(profile_id)
        )
    ...
    async def list_policy_assignments(self, **kwargs: Any) -> list[dict[str, Any]]:
        ...
        return self._dump(
            await self._require_client().list_mcp_policy_assignments(**kwargs)
        )

    async def create_policy_assignment(
        self, request_data: MCPPolicyAssignmentCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_policy_assignment(request)
        )
    ...
    async def update_policy_assignment(
        ...
        return self._dump(
            await self._require_client().update_mcp_policy_assignment(
    ...
    async def delete_policy_assignment(self, assignment_id: int) -> dict[str, Any]:
        ...
        return self._dump(
            await self._require_client().delete_mcp_policy_assignment(assignment_id)
        )
    ...
    async def create_approval_policy(
        self, request_data: MCPApprovalPolicyCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_approval_policy(request)
        )
    ...
    async def update_approval_policy(
        ...
        return self._dump(
            await self._require_client().update_mcp_approval_policy(
                approval_policy_id, request
            )
        )
    ...
    async def delete_approval_policy(self, approval_policy_id: int) -> dict[str, Any]:
        ...
        return self._dump(
            await self._require_client().delete_mcp_approval_policy(approval_policy_id)
        )

    async def create_approval_decision(
        self, request_data: MCPApprovalDecisionCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_approval_decision(request)
        )
    ...
    async def stream_events(
        ...
        *,
        ...
        async for event in self._require_client().stream_mcp_governance_events(
            **stream_kwargs
        ):
    ...
    async def list_org_tool_catalogs(self, *, org_id: int) -> list[dict[str, Any]]:
        ...
        return self._dump(
            await self._require_client().list_mcp_org_tool_catalogs(org_id)
        )

    async def create_org_tool_catalog(
        self, *, org_id: int, request_data: MCPCatalogCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        ...
        return self._dump(
            await self._require_client().create_mcp_org_tool_catalog(org_id, request)
        )
    ...
    async def delete_org_tool_catalog(
        ...
        return self._dump(
            await self._require_client().delete_mcp_org_tool_catalog(org_id, catalog_id)
        )
    ...
    async def add_org_catalog_entry(
        ...
        *,
        ...
        return self._dump(
            await self._require_client().add_mcp_org_catalog_entry(
                org_id, catalog_id, request
            )
        )
    ...
    async def delete_org_catalog_entry(
        ...
        return self._dump(
            await self._require_client().delete_mcp_org_catalog_entry(
                org_id, catalog_id, tool_name
            )
        )
    ...
    async def list_team_tool_catalogs(self, *, team_id: int) -> list[dict[str, Any]]:
        self._enforce("mcp.governance.catalogs.list.server")
        return self._dump(
            await self._require_client().list_mcp_team_tool_catalogs(team_id)
        )

    async def create_team_tool_catalog(
        self, *, team_id: int, request_data: MCPCatalogCreate | dict[str, Any]
    ) -> dict[str, Any]:
        # Deferred import: avoid module-scope tldw_api schema import (task-285 phase 2).
        from ..tldw_api import MCPCatalogCreate
        ...
        request = self._model(request_data, MCPCatalogCreate)
        return self._dump(
            await self._require_client().create_mcp_team_tool_catalog(team_id, request)
        )
    ...
    async def delete_team_tool_catalog(
        ...
        self._enforce("mcp.governance.catalogs.delete.server")
        return self._dump(
            await self._require_client().delete_mcp_team_tool_catalog(
                team_id, catalog_id
            )
        )
    ...
    async def add_team_catalog_entry(
        ...
        *,
        ...
        request = self._model(request_data, MCPCatalogEntryCreate)
        return self._dump(
            await self._require_client().add_mcp_team_catalog_entry(
                team_id, catalog_id, request
            )
        )
    ...
    async def delete_team_catalog_entry(
        ...
        self._enforce("mcp.governance.catalog_entries.delete.server")
        return self._dump(
            await self._require_client().delete_mcp_team_catalog_entry(
                team_id, catalog_id, tool_name
            )
        )
