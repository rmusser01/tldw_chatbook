...
class EvaluationState:
    ...
    def toggle_sidebar(self) -> None:
        ...
        self._notify_observers(
            "sidebar_collapsed", not self.sidebar_collapsed, self.sidebar_collapsed
        )
    ...
    def set_loading(self, key: str, is_loading: bool) -> None:
        ...
        if old_value != is_loading:
            self._notify_observers(
                "loading_states", {key: old_value}, {key: is_loading}
            )
    ...
    def clear_selection(self, category: str) -> None:
        ...
        if category in self.selected_items:
            ...
            self._notify_observers(
                "selected_items", {category: old_items}, {category: set()}
            )
    ...
    def start_draft_config(self) -> None:
        ...
        self.draft_config = EvaluationConfig(task_id="", model_id="", dataset_id="")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_runs": [
                run.to_dict() for run in self.recent_runs[:20]
            ],  # Keep last 20
        }
