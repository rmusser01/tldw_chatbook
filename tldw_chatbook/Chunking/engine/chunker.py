...
from tldw_chatbook.Chunking._shims.testing import is_test_mode
...
try:
    from tldw_chatbook.Chunking._shims.Metrics import (
        MetricDefinition,
        MetricType,
        add_span_event,
...
class Chunker:
    ...
    def chunk_file_stream(self,
        ...
        Notes:
            ...
            Semantics” in tldw_chatbook/Chunking/engine/README.md.
        """
