...
class EvalTemplateManager:
    ...
    def _analogy_reasoning_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metric": "accuracy",
            "generation_kwargs": {"temperature": 0.0, "max_tokens": 32},
    ...
    def _bias_evaluation_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metric": "accuracy",
            "generation_kwargs": {"temperature": 0.0, "max_tokens": 64},
    ...
    def _code_completion_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metric": "bleu",
            "generation_kwargs": {"temperature": 0.1, "max_tokens": 256},
    ...
    def _code_switching_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metric": "semantic_similarity",
            "generation_kwargs": {"temperature": 0.5, "max_tokens": 256},
    ...
    def _dialogue_generation_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "generation_kwargs": {"temperature": 0.6, "max_tokens": 768},
            "dialogue_types": [
                "casual",
                "professional",
                "conflict_resolution",
    ...
    def _open_ended_qa_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "generation_kwargs": {"temperature": 0.5, "max_tokens": 768},
    ...
    def _mmlu_physics_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "doc_to_target": "{answer}",
            "generation_kwargs": {"temperature": 0, "max_tokens": 1},
            "sample_problems": [
                {
    ...
    def list_templates(self, category: str = None) -> List[Dict[str, Any]]:
        ...
        for name, template in self.templates.items():
            if (
                category is None
                or template.get("metadata", {}).get("category") == category
            ):
                templates.append(
                    {
                        "name": name,
                        ...
                        "category": template.get("metadata", {}).get(
                            "category", "general"
                        ),
                        "difficulty": template.get("metadata", {}).get(
                            "difficulty", "unknown"
                        ),
                    }
                )
    ...
    def export_template_as_file(
        self, template_name: str, output_path: str, format_type: str = "json"
    ):
    ...
    def create_sample_dataset(
        self, template_name: str, output_path: str, num_samples: int = 10
    ):
        ...
        if len(sample_problems) >= num_samples:
            ...
            selected_problems = (
                sample_problems * ((num_samples // len(sample_problems)) + 1)
            )[:num_samples]

        # Format for dataset file
        dataset = []
        for i, problem in enumerate(selected_problems):
            dataset_item = {"id": f"{template_name}_{i:03d}", **problem}
