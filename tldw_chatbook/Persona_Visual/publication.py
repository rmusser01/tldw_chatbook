...
def _pin_source_asset(
    ...
    try:
        for component in parts[:-1]:
            ...
            # Adding an immutable version changes shared ancestors' timestamps
            # and sizes. Pin directory identity, while files retain full metadata
            # and byte/digest checks below.
